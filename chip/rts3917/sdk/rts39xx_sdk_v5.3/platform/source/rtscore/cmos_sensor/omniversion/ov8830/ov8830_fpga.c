...
static struct rts_isp_i2c_reg g_ov8830_i2c_init_2nd_regs[] = {
	{0x3011, 0x41}, {0x3015, 0x08}, {0x3090, 0x03}, {0x3091, 0x11},
	{0x3092, 0x02}, {0x3093, 0x00}, {0x30b3, 0x14}, {0x30b4, 0x04},
	{0x30b5, 0x04}, {0x30b6, 0x01}, {0x3500, 0x00}, {0x3501, 0x9b},
	{0x3502, 0x60}, {0x380F, 0xBE}, {0x4837, 0x0d}, {0x0100, 0x01},
};
