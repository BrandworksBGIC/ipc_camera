...
static struct rts_isp_i2c_reg g_gc2053_i2c_init_regs[] = {
	{0xfe, 0x80}, {0xfe, 0x80}, {0xfe, 0x80}, {0xfe, 0x00}, {0xf2, 0x00},
	{0xf3, 0x00}, {0xf4, 0x36}, {0xf5, 0xc0}, {0xf6, 0x44}, {0xf7, 0x03},
	{0xf8, 0x2c}, {0xf9, 0x42}, {0xfc, 0x8e}, {0xfe, 0x00}, {0x87, 0x18},
	{0xee, 0x30}, {0xd0, 0xb7}, {0x03, 0x04}, {0x04, 0x10}, {0x05, 0x04},
	{0x06, 0x4c}, {0x07, 0x00}, {0x08, 0x0c}, {0x09, 0x00}, {0x0a, 0x02},
	{0x0b, 0x00}, {0x0c, 0x02}, {0x12, 0xe2}, {0x13, 0x16}, {0x19, 0x0a},
	{0x21, 0x1c}, {0x28, 0x0a}, {0x29, 0x24}, {0x2b, 0x04}, {0x32, 0xd8},
	{0x37, 0x03}, {0x39, 0x17}, {0x44, 0x40}, {0x4b, 0x20}, {0x4e, 0x08},
	{0x55, 0x20}, {0x66, 0x05}, {0x67, 0x05}, {0x77, 0x00}, {0x78, 0x20},
	{0x7c, 0x93}, {0x8c, 0x12}, {0x8d, 0x92}, {0x90, 0x00}, {0x41, 0x04},
	{0x42, 0x64}, {0x9d, 0x10}, {0xce, 0x7c}, {0xd2, 0x41}, {0xd3, 0xec},
	{0xe6, 0x40}, {0xb6, 0xC0}, {0xb0, 0x58}, {0x26, 0x20}, {0xfe, 0x01},
	{0x40, 0x23}, {0x60, 0x40}, {0xfe, 0x01}, {0x94, 0x01}, {0x95, 0x04},
	{0x96, 0x40}, {0x97, 0x07}, {0x98, 0x88}, {0xfe, 0x01}, {0x01, 0x04},
	{0x02, 0x89}, {0x04, 0x01}, {0x50, 0x1c}, {0x89, 0x03}, {0xfe, 0x04},
	{0x28, 0x86}, {0x29, 0x86}, {0x2a, 0x86}, {0x2b, 0x68}, {0x2c, 0x68},
	{0x2d, 0x68}, {0x2e, 0x68}, {0x2f, 0x68}, {0x30, 0x4f}, {0x31, 0x68},
	{0x32, 0x67}, {0x33, 0x66}, {0x34, 0x66}, {0x35, 0x66}, {0x36, 0x66},
	{0x37, 0x66}, {0x38, 0x62}, {0x39, 0x62}, {0x3a, 0x62}, {0x3b, 0x62},
	{0x3c, 0x62}, {0x3d, 0x62}, {0x3e, 0x62}, {0x3f, 0x62}, {0xfe, 0x01},
	{0x9a, 0x03}, {0x99, 0x01}, {0xfe, 0x00}, {0x7b, 0x2a}, {0x23, 0x2d},
	{0xfe, 0x03}, {0x01, 0x27}, {0x02, 0x56}, {0x03, 0xb6}, {0x12, 0x88},
	{0x13, 0x07}, {0x15, 0x12}, {0xfe, 0x00}, {0x3e, 0x91},
};
