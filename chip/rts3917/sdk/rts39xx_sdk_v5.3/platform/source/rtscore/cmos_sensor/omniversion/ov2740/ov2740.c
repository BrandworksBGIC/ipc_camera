...
static struct rts_isp_i2c_reg g_ov2740_i2c_init_regs_linear[] = {
	...
	{0x030d, 0x1e},
	{0x030e, 0x02},
//	{0x030f, 0x04}, // 150310 New Setting
	{0x0312, 0x01},
	{0x3000, 0x00},
	{0x3018, 0x32},
	{0x3031, 0x0a},
	{0x3080, 0x08},
	{0x3083, 0xB4}, // 150310 New Setting
	{0x3103, 0x00},
	{0x3104, 0x01},
	{0x3106, 0x01},
	{0x3500, 0x00},
	{0x3501, 0x44},
	{0x3502, 0x40}, // 150310 New Setting
	{0x3503, 0x88},
	{0x3507, 0x00},
	{0x3508, 0x00},
	{0x3509, 0x80},
	...
	{0x365e, 0x1a},
	{0x3662, 0xd7},
	{0x3667, 0x78}, // 150310 New Setting
	{0x3669, 0x0a},
	{0x366a, 0x92}, // 150310 New Setting
	{0x3700, 0x54},
	{0x3702, 0x10},
	{0x3706, 0x42},
	{0x3709, 0x30},
	...
	{0x4016, 0x00},
	{0x4017, 0x10},
	{0x4044, 0x02},  // 150310 New Setting
	{0x4304, 0x08},
	{0x4307, 0x30},
	{0x4320, 0x80},
	{0x4322, 0x00},
	...
	{0x4504, 0x04},
	{0x4508, 0x02},
	{0x4601, 0x10},  // 150310 New Setting
	{0x4800, 0x00},
	{0x4816, 0x52},
	{0x4837, 0x16},  // 150310 New Setting
	{0x5000, 0x7f},
	{0x5001, 0x00},
	{0x5005, 0x38},
	{0x501e, 0x0d},
	{0x5040, 0x00},
	{0x5901, 0x00},
//	{0x3d8c, 0x71}, // 150310 New Setting
//	{0x3d8d, 0xe7}, // 150310 New Setting
	{0x0100, 0x01},
};
				...
				struct rts_isp_sensor_init_info *info)
{
	...
	if (mode->hdr == RTS_ISP_HDR_LINE_2TO1) {
		...
		info->hts = 2160 * 2;
		info->pclk = 144115200;
		info->min_vts = status->min_vts = 1112;
