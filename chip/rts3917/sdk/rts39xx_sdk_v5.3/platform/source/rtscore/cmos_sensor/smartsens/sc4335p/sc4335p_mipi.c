...
//pclk = 2700 * 1500 * 30 = 121,500,000
	...
	{0x301f, 0x01}, {0x3213, 0x05}, {0x3301, 0x10}, {0x3306, 0x60},
	{0x3309, 0x88}, {0x330a, 0x01}, {0x330b, 0x08}, {0x330e, 0x38},
	{0x330f, 0x04}, {0x3310, 0x20}, {0x3314, 0x94}, {0x331f, 0x79},
	{0x3342, 0x01}, {0x3347, 0x05}, {0x3364, 0x1d}, {0x3367, 0x10},
	{0x33b6, 0x07}, {0x33b7, 0x2f}, {0x33b8, 0x10}, {0x33b9, 0x18},
	{0x33ba, 0x70}, {0x360f, 0x05}, {0x3614, 0x80}, {0x3620, 0xa8},
	{0x3622, 0xf6}, {0x3625, 0x0a}, {0x3630, 0xc0}, {0x3631, 0x88},
	{0x3632, 0x18}, {0x3633, 0x33}, {0x3636, 0x25}, {0x3637, 0x70},
	{0x3638, 0x22}, {0x363a, 0x90}, {0x363b, 0x09}, {0x3650, 0x06},
	{0x366e, 0x04}, {0x3670, 0x0a}, {0x3671, 0xf6}, {0x3672, 0xf6},
	{0x3673, 0x16}, {0x3674, 0xc0}, {0x3675, 0xc8}, {0x3676, 0xaf},
	{0x367a, 0x08}, {0x367b, 0x38}, {0x367c, 0x38}, {0x367d, 0x3f},
	{0x3690, 0x33}, {0x3691, 0x34}, {0x3692, 0x44}, {0x369c, 0x38},
	{0x369d, 0x3f}, {0x36e9, 0x54}, {0x36f9, 0x54}, {0x3902, 0xc5},
	{0x3904, 0x10},
	...
	{0x3993, 0x0c}, {0x3994, 0x10}, {0x3995, 0x38}, {0x3996, 0x80},
	{0x3997, 0xff}, {0x3998, 0x08}, {0x3999, 0x16}, {0x399a, 0x28},
	{0x399b, 0x40}, {0x399c, 0x50}, {0x399d, 0x28}, {0x399e, 0x18},
	{0x399f, 0x0c}, {0x3e01, 0xbb}, {0x3e02, 0x00}, {0x3e09, 0x20},
	{0x3e25, 0x03}, {0x3e26, 0x20},
	{0x4800, 0x64}, {0x4818, 0x00}, {0x4819, 0x34}, {0x481a, 0x00},
	{0x481b, 0x1c}, {0x481c, 0x00}, {0x481d, 0xe9}, {0x4821, 0x02},
	{0x4822, 0x00}, {0x4823, 0x03}, {0x4828, 0x00}, {0x4829, 0x02},
	{0x5781, 0x04}, {0x5782, 0x04}, {0x5783, 0x02}, {0x5784, 0x02},
	{0x5785, 0x40}, {0x5786, 0x20}, {0x5787, 0x18}, {0x5788, 0x10},
	{0x5789, 0x10}, {0x57a4, 0xa0}, {0x5988, 0x02}, {0x598e, 0x0a},
	{0x598f, 0x2d}, {0x36e9, 0x54},
	{0x36f9, 0x54}, {0x0100, 0x01},
};
			       ...
			       struct rts_isp_sensor_init_info *info)
{
	...
	info->interface.mipi.hs_term = 0x04;
