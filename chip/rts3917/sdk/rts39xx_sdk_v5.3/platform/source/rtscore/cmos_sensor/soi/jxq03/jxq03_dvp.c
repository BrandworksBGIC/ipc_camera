...
static struct rts_isp_i2c_reg g_jxq03_30fps_i2c_init_regs[] = {
	...
	{0x20, 0x40}, {0x21, 0x06}, {0x22, 0xDC}, {0x23, 0x05},
	{0x24, 0x84}, {0x25, 0x10}, {0x26, 0x54}, {0x27, 0xB6},
	{0x28, 0x14}, {0x29, 0x04}, {0x2A, 0xAC}, {0x2B, 0x14},
	{0x2C, 0x00}, {0x2D, 0x00}, {0x2E, 0x4A}, {0x2F, 0x64},
	{0x41, 0x89}, {0x42, 0x14}, {0x47, 0x42}, {0x76, 0x4A},
	{0x77, 0x0B}, {0x80, 0x00}, {0xAF, 0x42}, {0xAB, 0x00},
	{0x46, 0x00}, {0x1D, 0xFF}, {0x1E, 0x1F}, {0x6C, 0xC0},
	{0x31, 0x0A}, {0x32, 0x21}, {0x33, 0x5C}, {0x34, 0x44},
	{0x35, 0x40}, {0x3A, 0xA0}, {0x3B, 0x38}, {0x3C, 0x50},
	{0x3D, 0x5B}, {0x3E, 0xFF}, {0x3F, 0x54}, {0x40, 0xFF},
	{0x56, 0xB2}, {0x59, 0x50}, {0x5A, 0x04}, {0x85, 0x34},
	{0x8A, 0x04}, {0x91, 0x08}, {0xA9, 0x08}, {0x9C, 0xE1},
	{0x5B, 0xA0}, {0x5C, 0x80}, {0x5D, 0xEF}, {0x5E, 0x14},
	{0x64, 0xE0}, {0x66, 0x04}, {0x67, 0x77}, {0x68, 0x00},
	{0x69, 0x41}, {0x7A, 0xA0}, {0x8F, 0x91}, {0x9D, 0x70},
	{0xAE, 0x30}, {0x13, 0x81}, {0x96, 0x04}, {0x4A, 0x01},
	{0x7E, 0xC9}, {0x50, 0x02}, {0x49, 0x10}, {0x7B, 0x4A},
	{0x7C, 0x0F}, {0x7F, 0x57}, {0x62, 0x21}, {0x90, 0x00},
	{0x8C, 0xFF}, {0x8D, 0xC7}, {0x8E, 0x00}, {0x8B, 0x01},
	{0x0C, 0x00}, {0xBB, 0x11}, {0x6A, 0x12}, {0x65, 0x32},
	{0x82, 0x01}, {0xA3, 0x20}, {0xA0, 0x01}, {0x81, 0x74},
	{0xA2, 0xFF}, {0x19, 0x20}, {0x12, 0x00}, {0x48, 0x85},
	{0x48, 0x05},
};
