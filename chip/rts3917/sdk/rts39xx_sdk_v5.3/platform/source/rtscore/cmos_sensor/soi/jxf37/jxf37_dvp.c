 ...
 * Copyright (C) 2020 Elton <elton.chung@realtek.com>
 */
...
static struct rts_isp_i2c_reg g_jxf37_i2c_init_regs_asic[] = {
	{0x12, 0x60}, {0x48, 0x85}, {0x48, 0x05}, {0x0E, 0x11}, {0x0F, 0x14},
	{0x10, 0x40}, {0x11, 0x80}, {0x0D, 0xF0}, {0x5F, 0x42}, {0x60, 0x2B},
	{0x58, 0x12}, {0x57, 0x60}, {0x9D, 0x00}, {0x20, 0xB0}, {0x21, 0x04},
	{0x22, 0xB0}, {0x23, 0x04}, {0x24, 0xC4}, {0x25, 0x40}, {0x26, 0x43},
	{0x27, 0x47}, {0x28, 0x19}, {0x29, 0x04}, {0x2A, 0x3C}, {0x2B, 0x14},
	{0x2C, 0x00}, {0x2D, 0x00}, {0x2E, 0x16}, {0x2F, 0x44}, {0x41, 0xC7},
	{0x42, 0x3B}, {0x47, 0x62}, {0x76, 0x6A}, {0x77, 0x09}, {0x1D, 0xFF},
	{0x1E, 0x1F}, {0x6C, 0xC0}, {0x31, 0x08}, {0x32, 0x27}, {0x33, 0x60},
	{0x34, 0x5E}, {0x35, 0x5E}, {0x3A, 0xAF}, {0x3B, 0x00}, {0x3C, 0x48},
	{0x3D, 0x5B}, {0x3E, 0xFF}, {0x3F, 0xA8}, {0x40, 0xFF}, {0x56, 0xB2},
	{0x59, 0xBE}, {0x5A, 0x04}, {0x85, 0x4D}, {0x8A, 0x04}, {0x91, 0x13},
	{0x9B, 0x03}, {0x9C, 0xE1}, {0xA9, 0x78}, {0x5B, 0xB0}, {0x5C, 0x71},
	{0x5D, 0x46}, {0x5E, 0x14}, {0x62, 0x01}, {0x63, 0x0F}, {0x64, 0xC0},
