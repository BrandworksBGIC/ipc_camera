...
static struct rts_isp_i2c_reg g_jxf28_30fps_i2c_init_regs[] = {
	{0x12, 0x40}, {0x0E, 0x11}, {0x0F, 0x04}, {0x10, 0x24},
	{0x11, 0x80}, {0x0D, 0xA0}, {0x48, 0x0A}, {0x5F, 0x01},
	{0x60, 0x20}, {0x58, 0x30}, {0x57, 0xC0}, {0x82, 0x60},
	{0x20, 0x00}, {0x21, 0x05}, {0x22, 0x65}, {0x23, 0x04},
	{0x24, 0xC0}, {0x25, 0x38}, {0x26, 0x43}, {0x27, 0xC1},
	{0x28, 0x28}, {0x29, 0x01}, {0x2C, 0x00}, {0x2D, 0x00},
	{0x2E, 0x18}, {0x2F, 0x44}, {0x41, 0xD8}, {0x42, 0x03},
	{0x76, 0x60}, {0x77, 0x09}, {0x1D, 0x00}, {0x1E, 0x04},
	{0x6C, 0x40}, {0x68, 0x00}, {0x6E, 0x2C}, {0x70, 0x90},
	{0x71, 0x6D}, {0x72, 0x84}, {0x73, 0x34}, {0x74, 0x02},
	{0x78, 0x20}, {0x89, 0x01}, {0x2A, 0xA3}, {0x2B, 0x25},
	{0x31, 0x10}, {0x32, 0x90}, {0x33, 0x10}, {0x37, 0x3F},
	{0x38, 0x4A}, {0x3B, 0x4C}, {0x3C, 0x5C}, {0x56, 0x32},
	{0x59, 0x60}, {0x64, 0x80}, {0x6F, 0x23}, {0x85, 0x38},
	{0x86, 0x40}, {0x8A, 0x06}, {0x5B, 0xB0}, {0x5C, 0x0F},
	{0x5D, 0x60}, {0x5E, 0x75}, {0x63, 0x82}, {0x66, 0x04},
	{0x67, 0x34}, {0x7A, 0x0F}, {0x4A, 0xF5}, {0x7E, 0xCD},
	{0x49, 0x10}, {0x50, 0x02}, {0x7B, 0x28}, {0x7C, 0x14},
	{0x7F, 0x5E}, {0x62, 0x40}, {0x8F, 0x80}, {0x90, 0x00},
	{0x8E, 0x00}, {0x8C, 0xFF}, {0x8D, 0xC7}, {0x8B, 0x01},
	{0x0C, 0x00}, {0x69, 0x7C}, {0x6A, 0x42}, {0x65, 0x02},
	{0x80, 0x03}, {0x81, 0x91}, {0x19, 0x20}, {0x12, 0x00},
	{0x39, 0xC1}, {0x39, 0x81},
	//PC:2483838570
};
...
static int jxf28_get_info(uint32_t isp_id, struct rts_isp_sensor_info *info)
{
	...
	info->modes.mode[0].fps = g_jxf28_fps_info[0].fps;
	info->modes.num = 1;
