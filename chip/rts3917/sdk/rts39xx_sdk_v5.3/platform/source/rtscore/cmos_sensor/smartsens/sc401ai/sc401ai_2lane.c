	{ 0x339c, 0x20 }, { 0x33ac, 0x10 }, { 0x33ae, 0x18 }, { 0x33af, 0x19 },
	{ 0x360f, 0x01 }, { 0x3620, 0x08 }, { 0x3637, 0x25 }, { 0x363a, 0x12 },
	{ 0x3670, 0x0a }, { 0x3671, 0x07 }, { 0x3672, 0x57 }, { 0x3673, 0x5e },
	{ 0x3674, 0x84 }, { 0x3675, 0x88 }, { 0x3676, 0x8a }, { 0x367a, 0x58 },
	{ 0x367b, 0x78 }, { 0x367c, 0x58 }, { 0x367d, 0x78 }, { 0x3690, 0x33 },
	{ 0x3691, 0x43 }, { 0x3692, 0x34 }, { 0x369c, 0x40 }, { 0x369d, 0x78 },
	{ 0x36ea, 0x39 }, { 0x36eb, 0x0d }, { 0x36ec, 0x2c }, { 0x36ed, 0x24 },
	{ 0x36fa, 0x39 }, { 0x36fb, 0x33 }, { 0x36fc, 0x10 }, { 0x36fd, 0x14 },
	{ 0x3908, 0x41 }, { 0x396c, 0x0e }, { 0x3e00, 0x00 }, { 0x3e01, 0xb6 },
	{ 0x3e02, 0x00 }, { 0x3e03, 0x0b }, { 0x3e08, 0x03 }, { 0x3e09, 0x40 },
	{ 0x3e1b, 0x2a }, { 0x4509, 0x30 }, { 0x4800, 0x44 }, { 0x5000, 0x46 },
	{ 0x5001, 0x44 }, { 0x57a8, 0xd0 }, { 0x5900, 0xf1 }, { 0x5901, 0x04 },
	{ 0x36e9, 0x23 }, { 0x36f9, 0x23 }, { 0x3221, 0x66 }, { 0x0100, 0x01 },
};
...
static int sc401ai_4m_get_init_info(uint32_t isp_id,
				    ...
				    struct rts_isp_sensor_init_info *info)
{
	...
	set_init_i2c_regs(info->sensor_regs[0],
			  g_sc401ai_4m_30fps_i2c_init_regs, 0);
...
static int sc401ai_hd_get_init_info(uint32_t isp_id,
				    const struct rts_isp_sensor_mode *mode,
				    struct rts_isp_sensor_init_info *info)
{
	struct sc401ai_status *status;
	...
	set_init_i2c_regs(info->sensor_regs[0],
			  g_sc401ai_hd_30fps_i2c_init_regs, 0);
...
static int sc401ai_get_init_info(uint32_t isp_id,
				 ...
				 struct rts_isp_sensor_init_info *info)
{
	if (isp_id >= SUPPORTED_ISP_NUM || !mode || !info)
		return -RTS_ISP_EINVAL;

	if (mode->size.w == 2560)
		return sc401ai_4m_get_init_info(isp_id, mode, info);
	else if (mode->size.w == 1280)
		return sc401ai_hd_get_init_info(isp_id, mode, info);
	else
		return -RTS_ISP_EINVAL;
}
