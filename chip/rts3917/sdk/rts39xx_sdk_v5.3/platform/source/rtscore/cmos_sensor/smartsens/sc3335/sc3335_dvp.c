...
//2312x1304 20fps dvp_clk=79.2M
	{0x0103, 0x01}, {0x0100, 0x00}, {0x36e9, 0x80}, {0x36f9, 0x80},
	{0x3001, 0xff}, {0x3002, 0xf0}, {0x300a, 0x24}, {0x3018, 0x6f},
	{0x301a, 0xf8}, {0x301c, 0x94},
	{0x301f, 0x0b},
	{0x3030, 0x02}, {0x303f, 0x81},
	{0x3200, 0x00}, {0x3201, 0x00}, {0x3202, 0x00},
	{0x3203, 0x00}, {0x3204, 0x09}, {0x3205, 0x0b}, {0x3206, 0x05},
	{0x3207, 0x1b}, {0x3208, 0x09}, {0x3209, 0x08}, {0x320a, 0x05},
	{0x320b, 0x18}, {0x320c, 0x05}, {0x320d, 0xdc}, {0x320e, 0x05},
	{0x320f, 0x2a}, {0x3210, 0x00}, {0x3211, 0x02}, {0x3212, 0x00},
	{0x3213, 0x03},
	{0x3250, 0x3f}, {0x3253, 0x04}, {0x3301, 0x04}, {0x3302, 0x10},
	{0x3304, 0x40}, {0x3306, 0x40}, {0x3309, 0x50}, {0x330b, 0xb6},
	{0x330e, 0x20}, {0x3310, 0x06}, {0x3314, 0x96}, {0x331e, 0x39},
	{0x331f, 0x49}, {0x3320, 0x09}, {0x3333, 0x10}, {0x334c, 0x01},
	{0x3364, 0x17}, {0x3367, 0x01}, {0x3390, 0x04}, {0x3391, 0x08},
	{0x3392, 0x38}, {0x3393, 0x05}, {0x3394, 0x09}, {0x3395, 0x32},
	{0x33ac, 0x0c}, {0x33ae, 0x1c}, {0x3622, 0x16}, {0x3637, 0x22},
	{0x363a, 0x1f}, {0x363c, 0x05}, {0x3641, 0x03},
	{0x3670, 0x0e}, {0x3674, 0xb0},
	...
	{0x369c, 0x18}, {0x369d, 0x38}, {0x36ea, 0x35}, {0x36eb, 0x05},
	{0x36ed, 0x04}, {0x36fa, 0x35}, {0x36fd, 0x06},
	{0x3908, 0x82}, {0x391f, 0x18},
	{0x3e01, 0xa4}, {0x3e02, 0x00}, {0x3f09, 0x48}, {0x4505, 0x08},
	{0x4509, 0x20}, {0x4603, 0x01},
	{0x4819, 0x09}, {0x481b, 0x05}, {0x481d, 0x14},
	{0x481f, 0x04}, {0x4821, 0x0a}, {0x4823, 0x05}, {0x4825, 0x04},
	{0x4827, 0x05}, {0x3000, 0x0f},
	{0x4829, 0x08}, {0x5799, 0x00}, {0x59e0, 0x60},
	...
	{0x59ed, 0x02}, {0x36e9, 0x27}, {0x36f9, 0x27}, {0x0100, 0x01},
};
			       ...
			       struct rts_isp_sensor_init_info *info)
{
	...
	info->min_vts = status->min_vts = 1322;
					...
					struct rts_isp_sync_regs *regs)
{
	...
	if (exp_gain->analog_gain[0] < 2) {
		...
		set_sync_i2c(&reg[i++], 0x330e, 0x20);
	} else if (exp_gain->analog_gain[0] < 8) {
		set_sync_i2c(&reg[i++], 0x363c, 0x07);
		set_sync_i2c(&reg[i++], 0x330e, 0x1c);
	} else {
		set_sync_i2c(&reg[i++], 0x363c, 0x07);
		set_sync_i2c(&reg[i++], 0x330e, 0x12);
	}
