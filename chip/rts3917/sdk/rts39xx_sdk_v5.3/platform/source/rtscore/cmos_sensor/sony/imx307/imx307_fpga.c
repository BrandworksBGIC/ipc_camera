...
static struct rts_isp_i2c_reg g_imx307_i2c_init_regs_linear[] = {
	...
	{0x300A, 0xF0}, {0x3011, 0x0A}, {0x3018, 0x46}, {0x3019, 0x05},
...
static struct rts_isp_i2c_reg g_imx307_i2c_init_regs_hdr[] = {
	{0x3002, 0x00}, {0x3005, 0x01}, {0x3007, 0x03}, {0x3009, 0x02},
	{0x300A, 0xF0}, {0x300C, 0x11}, {0x3011, 0x0A}, {0x3018, 0x46},
	{0x3019, 0x05}, {0x301C, 0x30}, {0x301D, 0x11}, {0x3020, 0x02},
	{0x3021, 0x00}, {0x3024, 0xC9}, {0x3025, 0x06}, {0x3030, 0x1F},
	...
	{0x3164, 0x1A}, {0x317C, 0x00}, {0x31EC, 0x0E}, {0x3405, 0x10},
	{0x3407, 0x01}, {0x3414, 0x0A}, {0x3415, 0x00}, {0x3418, 0xC8},
	{0x3419, 0x08}, {0x3441, 0x0C}, {0x3442, 0x0C}, {0x3443, 0x01},
	{0x3444, 0x20}, {0x3445, 0x25}, {0x3446, 0x57}, {0x3447, 0x00},
	{0x3448, 0x37}, {0x3449, 0x00}, {0x344A, 0x1F}, {0x344B, 0x00},
	{0x344C, 0x1F}, {0x344D, 0x00}, {0x344E, 0x1F}, {0x344F, 0x00},
	{0x3450, 0x77}, {0x3451, 0x00}, {0x3452, 0x1F}, {0x3453, 0x00},
	{0x3454, 0x17}, {0x3455, 0x00}, {0x3472, 0xA0}, {0x3473, 0x07},
	{0x347B, 0x23}, {0x3480, 0x49}, {0x3010, 0x61}, {0x30F0, 0x64},
	{0x3000, 0x00},
};
...
static int imx307_get_info(uint32_t isp_id, struct rts_isp_sensor_info *info)
{
	...
	info->modes.mode[i].fps = 16.16; /* 25 * 24 / 37.125 */
	i++;
	info->modes.mode[i].hdr = RTS_ISP_HDR_LINE_2TO1;
	info->modes.mode[i].size.w = 1920;
	info->modes.mode[i].size.h = 1080;
	info->modes.mode[i].fps = 8.08; /* 12.5 * 24 / 37.125 */
	i++;
	info->modes.num = i;
...
static int imx307_get_exposure_gain_info(uint32_t isp_id,
