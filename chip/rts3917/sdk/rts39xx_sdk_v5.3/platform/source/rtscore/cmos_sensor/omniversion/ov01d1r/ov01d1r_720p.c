...
static const struct fps_info g_ov01d1r_fps_info[] = {
	{30, 2900, 883, 76800000} //1280x720 ov china
};
...
static struct rts_isp_i2c_reg g_ov01d1r_i2c_init_regs[] = {
	...
	{0xaf, 0x11},// ;;Paf
	{0xbf, 0x0a},//
	{0x49, 0x00},//  ;;vos_sel_fix[1]
	{0xc7, 0x44},// ;; vos_sel_x2[7:4] vos_sel_x1[3:0]
	{0xc8, 0x55},// ;; vos_sel_x4[7:4] vos_sel_x3[3:0]
	{0xca, 0x2a},// ;;SC1_P86_x1
	{0xcb, 0x30},// ;;SC1_P86_x2
	{0xcc, 0x32},// ;;SC1_P86_x3
	{0xcd, 0x34},// ;;SC1_P86_x4
	{0xce, 0x28},// ;;SC2_P88_x1
	{0xcf, 0x2e},// ;;SC2_P88_x2
	{0xd0, 0x30},// ;;SC2_P88_x3
	{0xd1, 0x32},// ;;SC2_P88_x4
	{0xe4, 0x08},//
	//;;Timing Ctrl
	{0xfd, 0x01},//
	{0x12, 0x00},//
	...
	{0xd7, 0x00},// ;;[7:4]: bsun_sig_sel_x4_lcg  [3:0]: bsun_sig_sel_x3_lcg
	{0xfd, 0x05},//
	{0x7b, 0x03},//
	{0x7d, 0x70},//
	{0xfd, 0x05},//
	...
	{0xb7, 0x00},// ;;mipi colorbar
	{0xa0, 0x00},// ;;sif_v_start_3lsb
	{0xa1, 0x04},// ;00 ;;sif_v_start_8msb
	{0xa2, 0x02},// ;;sif_v_size_3lsb
	{0xa3, 0xd0},// ;d8 ;;sif_v_size_8msb  ;mipi  lost 1 line
	{0xa4, 0x00},// ;;sif_h_start_4lsb
	{0xa5, 0x04},// ;00 ;;sif_h_start_8msb
	{0xa6, 0x05},// ;;sif_h_size_4lsb
	{0xa7, 0x00},// ;08 ;;sif_h_size_8msb
	//;;OTP&ISP Setting;;;;;;;;;;
	{0xfd, 0x03},
	{0x9d, 0x0f},
	//;;BLC Setting;;;;;;;;;;
				 ...
				 struct rts_isp_sync_regs *regs)
{
	...
	if (abs(status->last_exposure - exp_gain->exposure[0]) > 0.001f) {
		...
		dummy = exp_gain->vts - status->min_vts + 61;
