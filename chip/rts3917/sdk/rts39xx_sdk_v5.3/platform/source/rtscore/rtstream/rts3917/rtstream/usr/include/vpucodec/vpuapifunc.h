...
void InterruptQ_Reset(Uint32 coreIdx, Uint32 instIndex);
Int32 InterruptQ_Enqueue(Uint32 coreIdx, Uint32 instIndex, Uint32 intReason);
Int32 InterruptQ_Dequeue(Uint32 coreIdx, Uint32 instIndex);
#endif
...
RetCode EncRegisterInputRingbuffer(EncHandle handle, FrameBuffer* fb);
