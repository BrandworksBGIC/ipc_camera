...
static int initr_get_kernel_offset(void)
{
	...
	working_fdt = (struct fdt_header *)map_to_sysmem(gd->fdt_blob);
#else
...
struct init_fnc_a init_sequence_r[] = {
	FUNC_I(initr_trace),
	FUNC_I(initr_reloc),
	FUNC_I(event_init),
	 ...
	 */
#endif
	FUNC_I(initr_reloc_global_data),
#if CONFIG_IS_ENABLED(NEEDS_MANUAL_RELOC) && CONFIG_IS_ENABLED(EVENT)
	FUNC_I(event_manual_reloc),
#endif
#if defined(CONFIG_SYS_INIT_RAM_LOCK) && defined(CONFIG_E500)
	FUNC_I(initr_unlock_ram_in_cache),
#endif
	FUNC_I(initr_barrier),
	FUNC_I(initr_malloc),
	FUNC_I(log_init),
	FUNC_I(initr_bootstage),	/* Needs malloc() but has its own timer */
#if defined(CONFIG_CONSOLE_RECORD)
	FUNC_I(console_record_init),
#endif
#ifdef CONFIG_SYS_NONCACHED_MEMORY
	FUNC_I(noncached_init),
#endif
	FUNC_I(initr_of_live),
#ifdef CONFIG_DM
	FUNC_I(initr_dm),
#endif
#ifdef CONFIG_ADDR_MAP
	FUNC_I(init_addr_map),
#endif
#if defined(CONFIG_ARM) || defined(CONFIG_RISCV) || defined(CONFIG_SANDBOX)
	FUNC_I(board_init),	/* Setup chipselects */
#endif
	/*
	 ...
	 */
#ifdef CONFIG_CLOCKS
	FUNC_I(set_cpu_clk_info), /* Setup clock information */
#endif
#ifdef CONFIG_EFI_LOADER
	FUNC_I(efi_memory_init),
#endif
	FUNC_I(initr_binman),
#ifdef CONFIG_FSP_VERSION2
	FUNC_I(arch_fsp_init_r),
#endif
	FUNC_I(initr_dm_devices),
	FUNC_I(stdio_init_tables),
	FUNC_I(serial_initialize),
	FUNC_I(initr_announce),
#ifndef CONFIG_FAST_BOOT
	FUNC_I(dm_announce),
#endif
#if CONFIG_IS_ENABLED(WDT)
	FUNC_I(initr_watchdog),
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
#endif
#if defined(CONFIG_NEEDS_MANUAL_RELOC) && defined(CONFIG_BLOCK_CACHE)
	FUNC_I(blkcache_init),
#endif
#ifdef CONFIG_NEEDS_MANUAL_RELOC
	FUNC_I(initr_manual_reloc_cmdtable),
#endif
	FUNC_I(arch_initr_trap),
#if defined(CONFIG_BOARD_EARLY_INIT_R)
	FUNC_I(board_early_init_r),
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
#endif
#ifdef CONFIG_POST
	FUNC_I(post_output_backlog),
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
#endif
	...
	FUNC_I(arch_early_init_r),
#endif
	FUNC_I(power_init_board),
#ifdef CONFIG_MTD_NOR_FLASH
	FUNC_I(initr_flash),
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
...
#endif
#ifdef CONFIG_EFI_LOADER
	FUNC_I(efi_init_early),
#endif
#ifdef CONFIG_CMD_NAND
	FUNC_I(initr_nand),
#endif
#ifdef CONFIG_CMD_ONENAND
	FUNC_I(initr_onenand),
#endif
#ifdef CONFIG_CRYPTO_BOOT
	FUNC_I(initr_crypto_boot),
#endif
#ifdef CONFIG_MMC
	FUNC_I(initr_mmc),
#endif
...
#endif
#ifdef CONFIG_PVBLOCK
	FUNC_I(initr_pvblock),
#endif
#ifndef CONFIG_FAST_BOOT
	FUNC_I(initr_env),
#ifdef CONFIG_OF_CONTROL
	FUNC_I(initr_get_kernel_offset),
#endif
#endif
#ifdef CONFIG_UPDATE_KERNEL_FROM_SD
	FUNC_I(load_bin_from_sd),
#endif
#ifdef CONFIG_SYS_MALLOC_BOOTPARAMS
	FUNC_I(initr_malloc_bootparams),
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
#endif
	FUNC_I(cpu_secondary_init_r),
#if defined(CONFIG_ID_EEPROM)
	FUNC_I(mac_read_from_eeprom),
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
#endif
	...
	FUNC_I(pci_init),
#endif
	FUNC_I(stdio_add_devices),
	FUNC_I(jumptable_init),
#ifdef CONFIG_API
	FUNC_I(api_init),
#endif
#ifndef CONFIG_FAST_BOOT
	FUNC_I(console_init_r),		/* fully init console as a device */
#endif
#ifdef CONFIG_DISPLAY_BOARDINFO_LATE
	FUNC_I(console_announce_r),
	FUNC_I(show_board_info),
#endif
#ifdef CONFIG_ARCH_MISC_INIT
	FUNC_I(arch_misc_init),		/* miscellaneous arch-dependent init */
#endif
#ifdef CONFIG_MISC_INIT_R
	FUNC_I(misc_init_r),		/* miscellaneous platform-dependent init */
#endif
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
#endif
	...
	FUNC_I(kgdb_init),
#endif
	FUNC_I(interrupt_init),
#if defined(CONFIG_MICROBLAZE) || defined(CONFIG_M68K)
	FUNC_I(timer_init,		/* initialize timer */
#endif
#if defined(CONFIG_LED_STATUS)
	FUNC_I(initr_status_led),
#endif
	/* PPC has a udelay(20) here dating from 2002. Why? */
#if defined(CONFIG_GPIO_HOG)
	FUNC_I(gpio_hog_probe_all),
#endif
#ifdef CONFIG_BOARD_LATE_INIT
	FUNC_I(board_late_init),
#endif
#if defined(CONFIG_SCSI) && !defined(CONFIG_DM_SCSI)
#ifdef INIT_FUNC_WATCHDOG_RESET
	FUNC_I(INIT_FUNC_WATCHDOG_RESET),
	 ...
	 * keyboard).
	 */
	FUNC_I(last_stage_init),
#endif
#if defined(CONFIG_PRAM)
	FUNC_I(initr_mem),
#endif
	FUNC_I(run_main_loop),
};
