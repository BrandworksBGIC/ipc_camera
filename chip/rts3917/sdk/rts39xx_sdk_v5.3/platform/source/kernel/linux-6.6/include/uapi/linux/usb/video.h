...
#define UVC_DT_ENCODE_UNIT_SIZE				13
#endif
...
struct  uvc_still_frame_descriptor {
	__u8 bLength;
	__u8 bDescriptorType;
	__u8 bDescriptorSubtype;
	__u8 bEndpointAddress;
	__u8 bNumImageSizePatterns;
	__u16 wWidth_wHeight[30];
	__u8 bNumCompressionPattern;
	__u8 bCompression;
} __attribute__((__packed__));

#define UVCG_STILL_FRAME_DESC_SIZE(n, m)   (10+4*n-4+m)
...
#define UVC_DT_FORMAT_H26X_SIZE				52

/* H.264 Payload - 3.1.2 H.264 Video Frame Descriptor */
...
#define UVC_DT_FRAME_H26X_SIZE(n)			(44+4*(n))
#else
...
#define UVC_DT_FORMAT_H26X_SIZE				28
...
#define UVC_DT_FRAME_H26X_SIZE(n)			(26+4*(n))
#endif
