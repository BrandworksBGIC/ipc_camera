...
static char fsg_string_interface[USB_MAX_STRING_LEN_WITH_NULL] = "Mass Storage";

#include "storage_common.h"
#include "f_mass_storage.h"

/* Static strings, in UTF-8 (for simplicity we use only ASCII characters) */
static struct usb_string		fsg_strings[FSG_STRING_INTERFACE + 1];
			 ...
			 struct usb_composite_dev *cdev, bool can_stall)
{
	...
	fsg_strings[FSG_STRING_INTERFACE].s = fsg_string_interface;
...
F_STR_ATTR(fsg_opts, fsg_opts, ifsg);
static struct configfs_attribute *fsg_attrs[] = {
	&fsg_opts_attr_stall,
#ifdef CONFIG_USB_GADGET_DEBUG_FILES
	&fsg_opts_attr_num_buffers,
#endif
	&f_fsg_opts_attr_ifsg,
	NULL,
};
...
static struct usb_function_instance *fsg_alloc_inst(void)
{
	...
	opts->ifsg = fsg_string_interface;
