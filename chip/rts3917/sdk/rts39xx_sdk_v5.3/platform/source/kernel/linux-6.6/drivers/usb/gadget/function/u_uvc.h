...
struct f_uvc_opts {
	...
	struct uvc_encode_unit_descriptor		uvc_encode;
#endif
	struct uvc_output_terminal_descriptor		uvc_output_terminal;
	struct uvc_still_frame_descriptor           uvc_still_frame[FORMAT_CNT];
	 ...
	 * gadgets.
	 */
	struct uvc_descriptor_header	*uvc_fs_control_cls[BASIC_ENTITY_NUMS
					+ UVC_STREAMING_NUMS + 1];
	struct uvc_descriptor_header	*uvc_ss_control_cls[BASIC_ENTITY_NUMS
					+ UVC_STREAMING_NUMS + 1];
	...
	/*
	 * Lock and Release rtsx_multi module
	 */
