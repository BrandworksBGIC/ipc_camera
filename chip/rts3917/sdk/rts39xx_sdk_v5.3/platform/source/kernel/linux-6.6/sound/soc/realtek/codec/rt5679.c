...
static int rt5679_reg_init(struct snd_soc_component *component)
{
	struct rt5679_priv *rt5679 = snd_soc_component_get_drvdata(component);
	int i;
...
{
	struct snd_soc_component *component = rt5679->component;
	int ret;
...
static void rt5679_set_dsp_mode(struct snd_soc_component *component, bool on)
{
	struct rt5679_priv *rt5679 = snd_soc_component_get_drvdata(component);
 ...
 */
int rt5679_headset_detect(struct snd_soc_component *component, int jack_insert)
{
	...
	if (!(value & 0x8000)) {
		if (rt5679->jack_type) {
			...
			case 0x0000:
				break;
			default:
				dev_err(rt5679->component->dev,
					"Unexpected button code 0x%04x\n",
					rt5679->jack_type);
				break;
			}
		} else {
			rt5679->jack_type = rt5679_headset_detect(component, 1);
			...
			rt5679->jack_type = rt5679_headset_detect(component, 0);
#ifdef CONFIG_SWITCH
...
int rt5679_set_jack_detect(struct snd_soc_component *component,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_DAC_S1F)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
				RT5679_EN_STO_DAC_ASRC,	RT5679_EN_STO_DAC_ASRC);
		break;
	default: /*disable*/
		snd_soc_component_update_bits(component, RT5679_ASRC2, RT5679_EN_STO_DAC_ASRC,
			0);
		break;
	}
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_DAC_M2F_L)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_DAC_M2F_R)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_DAC_M3F_L)
			snd_soc_component_update_bits(component, RT5679_ASRC1,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_DAC_M3F_R)
			snd_soc_component_update_bits(component, RT5679_ASRC1,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_ADC_S1F)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_ADC_S2F)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_ADC_S3F)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_ADC_MF_L)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	switch (ucontrol->value.integer.value[0]) {
	case 1 ... 7: /*enable*/
		if (snd_soc_component_read(component, RT5679_PWR_DIG2) & RT5679_PWR_ADC_MF_R)
			snd_soc_component_update_bits(component, RT5679_ASRC2,
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	dev_info(component->dev, "ret=0x%x\n",
		rt5679_headset_detect(component, jack_insert));
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	rt5679_set_dsp_mode(component, ucontrol->value.integer.value[0]);
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	if (snd_soc_component_read(component, RT5679_STO_HP_NG2_CTRL1) & 0x8000) {
		snd_soc_component_update_bits(component, RT5679_STO_HP_NG2_CTRL1, 0x8000,
			0x0000);
		snd_soc_component_update_bits(component, RT5679_STO_HP_NG2_CTRL1, 0x8000,
			0x8000);
	}
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	if (snd_soc_component_read(component, RT5679_MONO_AMP_NG2_CTRL1) & 0x8000) {
		snd_soc_component_update_bits(component, RT5679_MONO_AMP_NG2_CTRL1, 0x8000,
			0x0000);
		snd_soc_component_update_bits(component, RT5679_MONO_AMP_NG2_CTRL1, 0x8000,
			0x8000);
	}
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		ret = request_firmware(&fw, "ALC5679_50000000", component->dev);
		if (ret == 0) {
			rt5679_spi_burst_write(0x50000000, fw->data, fw->size);
			release_firmware(fw);
		}

		ret = request_firmware(&fw, "ALC5679_60000000", component->dev);
		if (ret == 0) {
...
static const struct snd_soc_dapm_route rt5679_dapm_routes[] = {
	...
	{ "Stereo DAC MIXR", "DAC2 L Switch", "DAC2 L Mux" },
			...
			unsigned int freq_in, unsigned int freq_out)
{
	...
	dev_dbg(component->dev, "m_bypass=%d k_bypass=%d m=%d n=%d k=%d\n",
	...
	struct device_attribute *attr, char *buf)
{
	...
	for (i = 0; i < rt5679->adb_reg_num; i++) {
		if (cnt + RT5679_REG_DISP_LEN >= PAGE_SIZE)
			break;
		val = snd_soc_component_read(component, rt5679->adb_reg_addr[i]);
...
static int rt5679_set_bias_level(struct snd_soc_component *component,
...
static int rt5679_probe(struct snd_soc_component *component)
{
	struct rt5679_priv *rt5679 = snd_soc_component_get_drvdata(component);
	int ret;
	...
	rt5679->component = component;

	rt5679_reg_init(component);
	...
	rt5679_set_bias_level(component, SND_SOC_BIAS_OFF);

	return 0;
}

static void rt5679_remove(struct snd_soc_component *component)
{
	rt5679_set_bias_level(component, SND_SOC_BIAS_OFF);
...
#ifdef CONFIG_PM
static int rt5679_suspend(struct snd_soc_component *component)
{
	return 0;
}

static int rt5679_resume(struct snd_soc_component *component)
{
	return 0;
}
#else
...
static struct snd_soc_component_driver soc_codec_dev_rt5679 = {
	.probe = rt5679_probe,
...
static const struct of_device_id rt5679_i2c_match[] = {
	{ .compatible = "realtek,rt5679", },
	{},
};
MODULE_DEVICE_TABLE(of, rt5679_i2c_match);
#endif
...
*/
	...
	return devm_snd_soc_register_component(&i2c->dev, &soc_codec_dev_rt5679,
			rt5679_dai, ARRAY_SIZE(rt5679_dai));
}

static void rt5679_i2c_remove(struct i2c_client *i2c)
{
#ifdef CONFIG_SWITCH
...
struct i2c_driver rt5679_i2c_driver = {
	.driver = {
		.name = "rt5679",
#if defined(CONFIG_OF)
		.of_match_table = rt5679_i2c_match,
#endif
	},
