...
struct rt56xx_ops {
	int (*index_write) (struct snd_soc_component *component,
			    unsigned int reg, unsigned int value);
	unsigned int (*index_read) (struct snd_soc_component *component,
				    unsigned int reg);
	int (*index_update_bits) (struct snd_soc_component *component,
