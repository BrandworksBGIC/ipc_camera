...
int rt5651_check_interrupt_event(struct snd_soc_component *component);
...
int rt5651_conn_mux_path(struct snd_soc_component *component,
		char *widget_name, char *path_name);
int rt5651_detect_hs_type(struct snd_soc_component *component, int jack_insert);
...
void rt5651_enable_ovcd_interrupt(struct snd_soc_component *component, bool enable);
