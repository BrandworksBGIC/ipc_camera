...
#define TR9_SEIP_OFFSET			0x40
/*
 * Each hart context has a vector of interrupt enable bits associated with it.
 * There's one bit for each interrupt source.
 */
#define ENABLE_BASE			(0x20 + TR9_SEIP_OFFSET)
...
#define CONTEXT_THRESHOLD		(0x1c + TR9_SEIP_OFFSET)
#define CONTEXT_CLAIM			(0x14 + TR9_SEIP_OFFSET)
#define CONTEXT_COMPLETE		(0x18 + TR9_SEIP_OFFSET)
