...
static const struct reg_sequence init_list[] = {
	...
	{RT5616_LOUT_CTRL2, 0x8000},//set Lineout to differential mode
	{RT5616_HPO_MIXER, 0x4000}, //HPVOL -> HPO
	{RT5616_HP_VOL, 0x8888}, //unmute HPVOL
	{RT5616_IN1_IN2, 0x0500}, //set IN2 to single-end mode and boost 40db
	{RT5616_STO1_ADC_MIXER, 0x3820},
	{RT5616_REC_L2_MIXER, 0x006b},
	{RT5616_REC_R2_MIXER, 0x006b},
};
...
static ssize_t rt5616_codec_show(struct device *dev,
				 struct device_attribute *attr, char *buf)
{
	struct i2c_client *client = to_i2c_client(dev);
	struct rt5616_priv *rt5616 = i2c_get_clientdata(client);
	struct snd_soc_component *component = rt5616->component;
	unsigned int val;
	int cnt = 0, i;

	cnt += sprintf(buf, "RT5616 codec register\n");
	for (i = 0; i <= RT5616_DEVICE_ID; i++) {
		if (cnt + 22 >= PAGE_SIZE)
			break;
...
static ssize_t rt5616_codec_store(struct device *dev,
				  ...
				  const char *buf, size_t count)
{
	...
	if (addr > RT5616_DEVICE_ID || val > 0xffff || val < 0)
		return count;
...
static DEVICE_ATTR(codec_reg, 0600, rt5616_codec_show, rt5616_codec_store);
...
static struct snd_soc_component_driver soc_codec_dev_rt5616 = {
	.probe = rt5616_probe,
...
static int rt5616_i2c_probe(struct i2c_client *i2c)
{
	...
	ret = regmap_multi_reg_write(rt5616->regmap, init_list,
	...
	return devm_snd_soc_register_component(&i2c->dev, &soc_codec_dev_rt5616,
