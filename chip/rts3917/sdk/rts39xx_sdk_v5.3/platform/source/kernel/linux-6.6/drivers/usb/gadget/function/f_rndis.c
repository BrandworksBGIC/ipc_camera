...
EXPORT_SYMBOL_GPL(fi_rndis);
struct usb_function *f_rndis;
EXPORT_SYMBOL_GPL(f_rndis);
...
static char def_data[USB_MAX_STRING_LEN_WITH_NULL] = "RNDIS Ethernet Data";
static char def_iad[USB_MAX_STRING_LEN_WITH_NULL] = "RNDIS";

static struct usb_string rndis_string_defs[3];
...
rndis_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	rndis_string_defs[0].s = def_ctrl;
	rndis_string_defs[1].s = def_data;
	rndis_string_defs[2].s = def_iad;
...
F_STR_ATTR(rndis_opts, f_rndis_opts, ictrl);
F_STR_ATTR(rndis_opts, f_rndis_opts, idata);
F_STR_ATTR(rndis_opts, f_rndis_opts, iad);
...
static struct configfs_attribute *rndis_attrs[] = {
	...
	&f_rndis_opts_attr_ictrl,
	&f_rndis_opts_attr_idata,
	&f_rndis_opts_attr_iad,
	NULL,
};
