...
#elif defined(CONFIG_CPU_R3K_TLB) || defined(CONFIG_CPU_RLX)
...
#if defined(CONFIG_CPU_R3K_TLB) || defined(CONFIG_CPU_RLX)
...
#define _PAGE_CHG_MASK	(_PAGE_ACCESSED | _PAGE_MODIFIED |	\
			 _PAGE_SOFT_DIRTY | _PFN_MASK | _CACHE_MASK | _CCA_MASK)
#else
#define _PAGE_CHG_MASK	(_PAGE_ACCESSED | _PAGE_MODIFIED |	\
