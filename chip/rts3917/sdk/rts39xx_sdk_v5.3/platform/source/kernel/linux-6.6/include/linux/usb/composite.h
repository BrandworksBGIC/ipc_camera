...
int config_ep_by_speed_and_alt_idx(struct usb_gadget *g,
		struct usb_function *f, struct usb_ep *_ep,
		u8 alt, u8 idx);
int usb_func_wakeup(struct usb_function *func);

void usb_remove_interface_id(struct usb_configuration *c, unsigned int id);
...
extern int composite_filteroutdata(struct usb_gadget *gadget,
		const struct usb_ctrlrequest *ctrl,
...
struct usb_msos_platform_capability_desc_header {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDevCapabilityType;
	__u8  bReserved;
	__u8  MS_OS_20_Platform_Capability_ID[16];
} __packed;
#define USB_DEVICE_CAPABILITY_DESCRIPTOR_TYPE	16
#define USB_DEVICE_CAPABILITY_PLATFORM		5
#define USB_DT_MSOS_HEAD_SIZE			20

struct usb_msos_descriptor_setinfo {
	__u8  dwWindowsVersion[4];
	__u16 wMSOSDescriptorSetTotalLength;
	__u8  bMS_VendorCode;
	__u8  bAltEnumCode;
} __packed;
#define MS_VendorCode				0x20
#define USB_DT_MSOS_SET_INFO_SIZE		8

struct usb_msos_desc_set_header {
	__u16 wLength;
...
#define USB_DT_MSOS_DESC_SET_HEADER_SIZE	10

struct usb_msos_function_subset_header {
	__u16 wLength;
	__u16 wDescriptorType;
...
#define USB_DT_MSOS_FUNCTION_SUBSET_HEADER_SIZE	8

struct usb_msos_compatible_id_desc {
	__u16 wLength;
	__u16 wDescriptorType;
	__u8  CompatibleID[8];
...
#define USB_DT_COMPATIBLE_ID_SIZE		20

struct usb_msos_registry_property_desc {
	__u16 wLength;
	__u16 wDescriptorType;
	__u16 wPropertyDataType;
	__u16 wPropertyNameLength;
	__u8  PropertyName[40];
	__u16 wPropertyDataLength;
	__u8  PropertyData[78];
} __packed;
#define MS_OS_20_FEATURE_REG_PROPERTY		4
#define REG_SZ					1
#define USB_DT_REGISTRY_PROPERTY_SIZE		128
