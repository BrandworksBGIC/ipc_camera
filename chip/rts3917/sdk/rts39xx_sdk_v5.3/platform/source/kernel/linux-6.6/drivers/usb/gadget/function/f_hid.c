...
struct usb_function_instance *fi_hid;
EXPORT_SYMBOL_GPL(fi_hid);
struct usb_function *f_hid;
EXPORT_SYMBOL_GPL(f_hid);
...
static char def_str[USB_MAX_STRING_LEN_WITH_NULL] = "HID Interface";

static struct usb_string ct_func_string_defs[CT_FUNC_HID_IDX + 1];
...
static int hidg_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	ct_func_string_defs[CT_FUNC_HID_IDX].s = def_str;
...
F_STR_ATTR(hid_opts, f_hid_opts, istr);
