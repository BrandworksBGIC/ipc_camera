...
void rtw_hal_set_rx_bcn_cnt(_adapter *adapter, u8 enable, u8 gpio_high_active, u8 gpio_input_en, u8 input_for_low);
void rtw_hal_set_tx_bcn_cnt(_adapter *adapter, u8 enable, u8 gpio_high_active, u8 gpio_input_en, u8 input_for_low);
#endif
