...
#define IS_8830A(version)					((GET_CVID_IC_TYPE(version) == CHIP_8830A) ? TRUE : FALSE)
...
#endif
#define IS_VENDOR_8830A_I_CUT_SERIES(_Adapter)		((IS_8830A(GET_HAL_DATA(_Adapter)->version_id)) ? ((GET_CVID_CUT_VERSION(GET_HAL_DATA(_Adapter)->version_id) >= I_CUT_VERSION) ? TRUE : FALSE) : FALSE)
