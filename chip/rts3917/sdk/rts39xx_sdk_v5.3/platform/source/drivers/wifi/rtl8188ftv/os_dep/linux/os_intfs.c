...
/*
 * 0: station mode, 1: AP mode
 */
int rtw_bcn_cnt_trx_switch = 0;
module_param(rtw_bcn_cnt_trx_switch, int, 0644);
#endif
...
u8 rtw_init_default_value(_adapter *padapter)
{
	...
	_rtw_spinlock_init(&bcn_cntpriv->bcn_lock);
...
#endif
#ifdef CONFIG_BCN_CNT
	rtw_hal_switch_gpio_wl_ctrl(padapter, BCN_CNT_GPIO_IDX, _FALSE);
#endif
