 ...
 *
 *****************************************************************************/
#ifndef __INC_HAL8830APHYCFG_H__
#define __INC_HAL8830APHYCFG_H__
 ...
 *   */
u32	PHY_QueryBBReg8830A(PADAPTER	Adapter,
				u32		RegAddr,
				u32		BitMask);
void	PHY_SetBBReg8830A(PADAPTER	Adapter,
				u32		RegAddr,
				u32		BitMask,
				u32		Data);
u32	PHY_QueryRFReg8830A(PADAPTER	Adapter,
				enum rf_path		eRFPath,
				u32				RegAddr,
				u32				BitMask);
void	PHY_SetRFReg8830A(PADAPTER		Adapter,
				enum rf_path		eRFPath,
				u32				RegAddr,
				u32				BitMask,
				u32				Data);
...
int	PHY_MACConfig8830A(PADAPTER	Adapter);
int	PHY_BBConfig8830A(PADAPTER	Adapter);
int	PHY_RFConfig8830A(PADAPTER	Adapter);

/* RF config */
int	rtl8830a_PHY_ConfigRFWithParaFile( PADAPTER Adapter, u8 *pFileName, enum rf_path eRFPath);
 ...
 * BB TX Power R/W
 *   */
void	PHY_SetTxPowerLevel8830A(PADAPTER		Adapter,
					u8			channel);
...
void	PHY_SetBWMode8830A(PADAPTER			pAdapter,
...
void	PHY_SwChnl8830A(PADAPTER		pAdapter,
				u8			channel);
 ...
 *   */
void phy_set_rf_path_switch_8830a(struct dm_struct	*phydm, bool		bMain);
 ...
 *   */
#if (RTL8830A_SUPPORT == 1) && (RTL8830A_FPGA_TRUE_PHY_VERIFICATION == 1)
	#define	SIC_ENABLE				1
