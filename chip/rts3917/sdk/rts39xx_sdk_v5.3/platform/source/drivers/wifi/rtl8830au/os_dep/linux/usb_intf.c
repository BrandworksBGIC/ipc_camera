...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	/*=== Realtek demoboard ===*/
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x8830), .driver_info = RTL8830A}, /* 8830AUS */
	{USB_DEVICE(USB_VENDER_ID_REALTEK, 0x0179), .driver_info = RTL8830A}, /* 8830ATV */
	/*=== Customer ID ===*/
	/****** 8830AUS ********/
	{USB_DEVICE(0x07B8, 0x8830), .driver_info = RTL8830A}, /* Abocom - Abocom */
#endif
...
#ifdef CONFIG_RTL8830A
	if (pdvobjpriv->chip_type == RTL8830A)
		rtl8830au_set_hw_type(pdvobjpriv);
#endif
...
#ifdef CONFIG_RTL8830A
	if (rtw_get_chip_type(padapter) == RTL8830A)
		rtl8830au_set_hal_ops(padapter);
#endif
