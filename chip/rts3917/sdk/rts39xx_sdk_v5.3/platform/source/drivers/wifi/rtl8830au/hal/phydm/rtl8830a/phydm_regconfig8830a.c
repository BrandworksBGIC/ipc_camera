...
void odm_config_rf_reg_8830a(struct dm_struct *dm, u32 addr, u32 data,
...
void odm_config_rf_radio_a_8830a(struct dm_struct *dm, u32 addr, u32 data)
{
	u32 content = 0x1000; /* RF_Content: radioa_txt */
	u32 maskfor_phy_set = (u32)(content & 0xE000);

	odm_config_rf_reg_8830a(dm, addr, data, RF_PATH_A, addr | maskfor_phy_set);
...
void odm_config_rf_radio_b_8830a(struct dm_struct *dm, u32 addr, u32 data)
{
	u32 content = 0x1001; /* RF_Content: radiob_txt */
	u32 maskfor_phy_set = (u32)(content & 0xE000);

	odm_config_rf_reg_8830a(dm, addr, data, RF_PATH_B, addr | maskfor_phy_set);
...
void odm_config_mac_8830a(struct dm_struct *dm, u32 addr, u8 data)
{
...
void odm_config_bb_agc_8830a(struct dm_struct *dm, u32 addr, u32 bitmask,
			     u32 data)
{
...
void odm_config_bb_phy_reg_pg_8830a(struct dm_struct *dm, u32 band, u32 rf_path,
...
void odm_config_bb_txpwr_lmt_8830a(struct dm_struct *dm, u8 *regulation,
...
void odm_config_bb_phy_8830a(struct dm_struct *dm, u32 addr, u32 bitmask,
			     u32 data)
{
	if (addr == 0xfe) {
#ifdef CONFIG_LONG_DELAY_ISSUE
