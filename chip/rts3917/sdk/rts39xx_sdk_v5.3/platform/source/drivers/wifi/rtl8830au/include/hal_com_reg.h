...
/* 8830A PKT_BUFF_ACCESS_CTRL value */
...
#define REG_AFE_LDO_CTRL				0x0027 /* 1.5v for 8830AE test chip, 1.4v for MP chip */
...
#define REG_AFE_XTAL_CTRL_EXT			0x0078 /* RTL8830A */
#define REG_XCK_OUT_CTRL				0x007c /* RTL8830A */
#define REG_MCUFWDL					0x0080
#define REG_WOL_EVENT					0x0081 /* RTL8830A */
...
#define REG_32K_CTRL					0x0194 /* RTL8830A */
#define REG_C2HEVT_MSG_NORMAL		0x01A0
#define REG_C2HEVT_CLEAR				0x01AF
#define REG_MCUTST_1					0x01c0
#define REG_MCUTST_WOWLAN			0x01C7	/* Defined after 8830A series. */
...
/* ----------------------------------------------------------------------------
* 8723/8830A Host System Interrupt Mask Register (offset 0x58, 32 byte)
* ---------------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------------
* 8723/8830A Host System Interrupt Status Register (offset 0x5C, 32 byte)
* ---------------------------------------------------------------------------- */
...
/* RTL8723/RTL8830A SDIO Host Interrupt Mask Register */
 ...
 * ******************************************************** */
	...
	#define LAST_ENTRY_OF_TX_PKT_BUFFER_8830A(__Adapter)	(175)
#else
	#define LAST_ENTRY_OF_TX_PKT_BUFFER_8830A(__Adapter)	(IS_VENDOR_8830A_I_CUT_SERIES(__Adapter) ? 255 : 175)
#endif
...
#define	HAL_8830A_HW_GPIO_WPS_BIT	BIT(7)
