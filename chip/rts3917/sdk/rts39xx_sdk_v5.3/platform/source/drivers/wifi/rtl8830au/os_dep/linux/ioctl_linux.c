...
extern void rtl8830a_cal_txdesc_chksum(struct tx_desc *ptxdesc);
#define cal_txdesc_chksum(padapter, desc) rtl8830a_cal_txdesc_chksum(desc)
#ifdef CONFIG_SDIO_HCI || defined(CONFIG_GSPI_HCI)
extern void rtl8830as_fill_default_txdesc(struct xmit_frame *pxmitframe, u8 *pbuf);
#define fill_default_txdesc rtl8830as_fill_default_txdesc
