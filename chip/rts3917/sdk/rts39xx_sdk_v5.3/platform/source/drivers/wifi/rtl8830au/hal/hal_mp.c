...
void hal_mpt_SwitchRfSetting(PADAPTER	pAdapter)
{
	...
	if (IS_HARDWARE_TYPE_8830AS(pAdapter) && (1 <= ChannelToSw && ChannelToSw <= 11) &&
	...
	} else if (IS_HARDWARE_TYPE_8830AE(pAdapter)) { /* <20140903, VincentL> Asked by RF Eason and Edlu*/
...
)
{
	...
	if (IS_HARDWARE_TYPE_8830A(pAdapter) || IS_HARDWARE_TYPE_8723B(pAdapter) ||
