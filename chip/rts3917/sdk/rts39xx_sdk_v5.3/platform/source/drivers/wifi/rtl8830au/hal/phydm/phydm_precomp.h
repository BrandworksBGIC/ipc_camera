...
#ifndef RTL8830A_SUPPORT
	#define	RTL8830A_SUPPORT	0
#endif
...
rtw_phydm_cfg_phy_para(
	...
	#define RTL8830A_T_SUPPORT 1
	#ifdef CONFIG_SFW_SUPPORTED
		#define RTL8830A_S_SUPPORT 1
	#else
		#define RTL8830A_S_SUPPORT 0
	#endif

	#include "rtl8830a/hal8830arateadaptive.h" /* @for  RA,Power training */
	#include "rtl8830a/halhwimg8830a_mac.h"
	#include "rtl8830a/halhwimg8830a_rf.h"
	#include "rtl8830a/halhwimg8830a_bb.h"
	#include "rtl8830a/phydm_regconfig8830a.h"
	#include "rtl8830a/phydm_rtl8830a.h"
	#include "rtl8830a/hal8830areg.h"
	#include "rtl8830a/version_rtl8830a.h"
	#if (DM_ODM_SUPPORT_TYPE == ODM_CE)
		#include "rtl8830a_hal.h"
		#include "halrf/rtl8830a/halrf_8830a_ce.h"
	#endif
	#if (DM_ODM_SUPPORT_TYPE == ODM_WIN)
		#include "halrf/rtl8830a/halrf_8830a_win.h"
	#endif
	#if (DM_ODM_SUPPORT_TYPE == ODM_AP)
		#include "halrf/rtl8830a/halrf_8830a_ap.h"
	#endif
#endif /* @88E END */
