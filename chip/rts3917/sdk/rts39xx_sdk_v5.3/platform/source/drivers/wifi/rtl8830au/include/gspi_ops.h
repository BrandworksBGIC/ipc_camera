...
struct spi_more_data {
	...
	void rtl8830as_set_hal_ops(PADAPTER padapter);
	#define set_hal_ops rtl8830as_set_hal_ops
#endif
...
extern u8 HalQueryTxBufferStatus8723ASdio(PADAPTER padapter);
...
#ifdef CONFIG_RTL8830A
	extern void InitInterrupt8830AGspi(PADAPTER padapter);
	extern void EnableInterrupt8830AGspi(PADAPTER padapter);
	extern void DisableInterrupt8830AGspi(PADAPTER padapter);
	extern void UpdateInterruptMask8830AGspi(PADAPTER padapter, u32 AddMSR, u32 RemoveMSR);
	...
	extern void ClearInterrupt8830AGspi(PADAPTER padapter);
	extern u8 CheckIPSStatus(PADAPTER padapter);
#endif /* CONFIG_RTL8830A */
