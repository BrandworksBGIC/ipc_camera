...
)
{
	...
	if (dm->support_ic_type == ODM_RTL8830A || dm->support_ic_type == ODM_RTL8723B ||
...
)
{
	...
	if (!tm_trigger) {
		if (IS_HARDWARE_TYPE_8830A(adapter) || IS_HARDWARE_TYPE_JAGUAR(adapter) || IS_HARDWARE_TYPE_8192E(adapter) || IS_HARDWARE_TYPE_8192F(adapter)
