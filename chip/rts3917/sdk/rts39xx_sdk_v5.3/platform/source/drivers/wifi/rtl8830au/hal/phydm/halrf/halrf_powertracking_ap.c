...
#endif/* endif (CONFIG_RTL8830A==1) */
#elif (DM_ODM_SUPPORT_TYPE & (ODM_AP))

#ifdef RTL8830A_SUPPORT
	{
		dm->rf_calibrate_info.is_txpowertracking = true;
		dm->rf_calibrate_info.tx_powercount = 0;
		dm->rf_calibrate_info.is_txpowertracking_init = false;
...
#if RTL8830A_SUPPORT
	if (GET_CHIP_VER(priv) == VERSION_8830A) {
...
)
{
	...
	if (!dm->rf_calibrate_info.tm_trigger) {	/* at least delay 1 sec */
		...
		odm_txpowertracking_callback_thermal_meter_8830a(adapter);
		dm->rf_calibrate_info.tm_trigger = 0;
	}
#endif
...
#if ((RTL8830A_SUPPORT == 1) || (RTL8192E_SUPPORT == 1) || (RTL8812A_SUPPORT == 1) || (RTL8881A_SUPPORT == 1) || (RTL8814A_SUPPORT == 1) || (RTL8197F_SUPPORT == 1) || (RTL8192F_SUPPORT == 1) || (RTL8198F_SUPPORT == 1) || (RTL8814B_SUPPORT == 1) || (RTL8812F_SUPPORT == 1) || (RTL8197G_SUPPORT == 1))
	if (!dm->rf_calibrate_info.tm_trigger) {
		if (dm->support_ic_type & (ODM_RTL8830A | ODM_RTL8192E | ODM_RTL8812 | ODM_RTL8881A | ODM_RTL8814A | ODM_RTL8197F | ODM_RTL8822B | ODM_RTL8821C | ODM_RTL8192F | ODM_RTL8198F)) {
