...
#ifdef CONFIG_BCN_CNT
/* 0x2E */
#define SET_H2CCMD_RX_BCN_CNT_EN(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 0, 1, __Value)
#define SET_H2CCMD_RX_BCN_CNT_ACTIVE(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 1, 1, __Value)
#define SET_H2CCMD_RX_BCN_CNT_INPUT_EN(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 2, 1, __Value)
#define SET_H2CCMD_RX_BCN_CNT_INPUT_LOW(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 3, 1, __Value)
#define SET_H2CCMD_RX_BCN_CNT_PORTID(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 5, 3, __Value)
#define SET_H2CCMD_RX_BCN_CNT_GPIO_NUM(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+1, 0, 7, __Value)
#define SET_H2CCMD_RX_BCN_CNT_PULSE_CNT(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+2, 0, 7, __Value)
#define SET_H2CCMD_RX_BCN_CNT_PULSE_EN(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+2, 7, 1, __Value)
#define SET_H2CCMD_RX_BCN_CNT_GPIO_DURATION(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+3, 0, 7, __Value)
#define SET_H2CCMD_RX_BCN_CNT_GPIO_DURATION_UNIT(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+3, 7, 1, __Value)

/* 0x2F */
#define SET_H2CCMD_TX_BCN_CNT_EN(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 0, 1, __Value)
#define SET_H2CCMD_TX_BCN_CNT_ACTIVE(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 1, 1, __Value)
#define SET_H2CCMD_TX_BCN_CNT_INPUT_EN(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 2, 1, __Value)
#define SET_H2CCMD_TX_BCN_CNT_INPUT_LOW(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 3, 1, __Value)
#define SET_H2CCMD_TX_BCN_CNT_MBSSID(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd, 5, 3, __Value)
#define SET_H2CCMD_TX_BCN_CNT_GPIO_NUM(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+1, 0, 7, __Value)
#define SET_H2CCMD_TX_BCN_CNT_PULSE_CNT(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+2, 0, 7, __Value)
#define SET_H2CCMD_TX_BCN_CNT_PULSE_EN(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+2, 7, 1, __Value)
#define SET_H2CCMD_TX_BCN_CNT_GPIO_DURATION(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+3, 0, 7, __Value)
#define SET_H2CCMD_TX_BCN_CNT_GPIO_DURATION_UNIT(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE(__pH2CCmd+3, 7, 1, __Value)
#endif
