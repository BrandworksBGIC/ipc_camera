...
typedef enum _HARDWARE_TYPE {
	HARDWARE_TYPE_RTL8830AE,
	HARDWARE_TYPE_RTL8830AU,
	HARDWARE_TYPE_RTL8830AS,
	/*	NEW_GENERATION_IC */
 ...
 * RTL8830A Series
 *   */
#define IS_HARDWARE_TYPE_8830AE(_Adapter)	(rtw_get_hw_type(_Adapter) == HARDWARE_TYPE_RTL8830AE)
#define IS_HARDWARE_TYPE_8830AU(_Adapter)	(rtw_get_hw_type(_Adapter) == HARDWARE_TYPE_RTL8830AU)
#define IS_HARDWARE_TYPE_8830AS(_Adapter)	(rtw_get_hw_type(_Adapter) == HARDWARE_TYPE_RTL8830AS)
#define	IS_HARDWARE_TYPE_8830A(_Adapter)	\
	(IS_HARDWARE_TYPE_8830AE(_Adapter) || IS_HARDWARE_TYPE_8830AU(_Adapter) || IS_HARDWARE_TYPE_8830AS(_Adapter))
