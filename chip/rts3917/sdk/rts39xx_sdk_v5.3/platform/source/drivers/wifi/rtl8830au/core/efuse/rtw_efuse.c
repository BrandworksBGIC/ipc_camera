...
BOOLEAN efuse_IsMasked(PADAPTER pAdapter, u16 Offset)
{
	...
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		return (IS_MASKED(8830A, _MUSB, Offset)) ? TRUE : FALSE;
#endif
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		return (IS_MASKED(8830A, _MPCIE, Offset)) ? TRUE : FALSE;
#endif
#if defined(CONFIG_RTL8192E)
	if (IS_HARDWARE_TYPE_8192E(pAdapter))
...
#ifdef CONFIG_SDIO_HCI
#ifdef CONFIG_RTL8830A_SDIO
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		return (IS_MASKED(8830A, _MSDIO, Offset)) ? TRUE : FALSE;
#endif
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		GET_MASK_ARRAY(8830A, _MUSB, pArray);
#endif
#if defined(CONFIG_RTL8812A)
	if (IS_HARDWARE_TYPE_8812(pAdapter))
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		GET_MASK_ARRAY(8830A, _MPCIE, pArray);
#endif
#if defined(CONFIG_RTL8192E)
	if (IS_HARDWARE_TYPE_8192E(pAdapter))
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		GET_MASK_ARRAY(8830A, _MSDIO, pArray);
#endif
#if defined(CONFIG_RTL8723B)
	if (IS_HARDWARE_TYPE_8723BS(pAdapter))
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		return GET_MASK_ARRAY_LEN(8830A, _MUSB);
#endif
#if defined(CONFIG_RTL8812A)
	if (IS_HARDWARE_TYPE_8812(pAdapter))
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		return GET_MASK_ARRAY_LEN(8830A, _MPCIE);
#endif
#if defined(CONFIG_RTL8192E)
	if (IS_HARDWARE_TYPE_8192E(pAdapter))
...
#if defined(CONFIG_RTL8830A)
	if (IS_HARDWARE_TYPE_8830A(pAdapter))
		return GET_MASK_ARRAY_LEN(8830A, _MSDIO);
#endif
#if defined(CONFIG_RTL8723B)
	if (IS_HARDWARE_TYPE_8723BS(pAdapter))
		...
		BOOLEAN		bPseudoTest)
{
	...
	if (IS_HARDWARE_TYPE_8723B(pAdapter) ||
	    ...
	    (IS_VENDOR_8830A_I_CUT_SERIES(pAdapter)) || (IS_CHIP_VENDOR_SMIC(pHalData->version_id))
	   ) {
