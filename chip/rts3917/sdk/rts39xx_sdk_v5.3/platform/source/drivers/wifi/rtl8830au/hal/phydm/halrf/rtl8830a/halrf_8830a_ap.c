...
)
{
	if (method == TXAGC) {
		...
		if (rf_path == RF_PATH_A) {
			set_iqk_matrix_8830a(dm, dm->rf_calibrate_info.bb_swing_idx_ofdm[RF_PATH_A], RF_PATH_A,
			...
			set_iqk_matrix_8830a(dm, dm->rf_calibrate_info.bb_swing_idx_ofdm[RF_PATH_B], RF_PATH_B,
...
)
{
	...
	if (t == 0) {
		 ...
		 * 			RTPRINT(FINIT, INIT_IQK, ("_phy_iq_calibrate_8830a()==>0x%08x\n",bbvalue)); */
