...
#define HALRF_IQK_VER \
	(dm->support_ic_type == ODM_RTL8830A) ? IQK_VER_8830A : \
...
#define HALRF_LCK_VER \
	(dm->support_ic_type == ODM_RTL8830A) ? LCK_VER_8830A : \
...
#define HALRF_POWRTRACKING_VER \
	(dm->support_ic_type == ODM_RTL8830A) ? PWRTRK_VER_8830A : \
...
#define HALRF_DPK_VER \
	(dm->support_ic_type == ODM_RTL8830A) ? DPK_VER_8830A : \
...
#define HALRF_KFREE_VER \
	(dm->support_ic_type == ODM_RTL8830A) ? KFREE_VER_8830A : \
...
#define HALRF_PABIASK_VER \
	(dm->support_ic_type == ODM_RTL8830A) ? PABIASK_VER_8830A : \
