...
u8 rtw_mi_get_ifbmp_mlme(struct dvobj_priv *dvobj, u32 role_sbmp, u32 mlme_sbmp);
_adapter *rtw_mi_get_iface_mlme(struct dvobj_priv *dvobj, u32 role_sbmp, u32 mlme_sbmp);

#define rtw_mi_get_ifbmp_by_hwband(dvobj, band_idx) rtw_mi_get_ifbmp_mlme(dvobj, WIFI_NULL_STATE, 0)
#define rtw_mi_get_iface_by_hwband(dvobj, band_idx) rtw_mi_get_iface_mlme(dvobj, WIFI_NULL_STATE, 0)

#define rtw_mi_get_ld_sta_ifbmp_by_hwband(dvobj, band_idx) rtw_mi_get_ifbmp_mlme(dvobj, WIFI_STATION_STATE, WIFI_ASOC_STATE)
...
#define rtw_mi_get_ld_sta_ifbmp(adapter) rtw_mi_get_ifbmp_mlme(adapter_to_dvobj(adapter), WIFI_STATION_STATE, WIFI_ASOC_STATE)
#define rtw_mi_get_ld_sta_iflbmp(adapter_link) IFBMP_TO_IFLBMP(rtw_mi_get_ld_sta_ifbmp(adapter_link->adapter))

#define rtw_mi_get_lgd_sta_ifbmp_by_hwband(dvobj, band_idx) rtw_mi_get_ifbmp_mlme(dvobj, WIFI_STATION_STATE, WIFI_UNDER_LINKING | WIFI_ASOC_STATE)
...
#define rtw_mi_get_lgd_sta_ifbmp(adapter) rtw_mi_get_ifbmp_mlme(adapter_to_dvobj(adapter), WIFI_STATION_STATE, WIFI_UNDER_LINKING | WIFI_ASOC_STATE)
#define rtw_mi_get_lgd_sta_iflbmp(adapter_link) IFBMP_TO_IFLBMP(rtw_mi_get_lgd_sta_ifbmp(adapter_link->adapter))

#define rtw_mi_get_ap_mesh_ifbmp_by_hwband(dvobj, band_idx) rtw_mi_get_ifbmp_mlme(dvobj, WIFI_AP_STATE | WIFI_MESH_STATE, WIFI_ASOC_STATE)
...
#define rtw_mi_get_ap_mesh_ifbmp(adapter) rtw_mi_get_ifbmp_mlme(adapter_to_dvobj(adapter), WIFI_AP_STATE | WIFI_MESH_STATE, WIFI_ASOC_STATE)
#define rtw_mi_get_ap_mesh_iflbmp(adapter_link) IFBMP_TO_IFLBMP(rtw_mi_get_ap_mesh_ifbmp(adapter_link->adapter))
#define rtw_mi_get_ap_mesh_iface_by_hwband(dvobj, band_idx) rtw_mi_get_iface_mlme(dvobj, WIFI_AP_STATE | WIFI_MESH_STATE, WIFI_ASOC_STATE)
...
#define rtw_mi_get_ap_adapter(adapter) rtw_mi_get_iface_mlme(adapter_to_dvobj(adapter), WIFI_AP_STATE, WIFI_ASOC_STATE)
#define rtw_mi_get_linking_adapter(adapter) rtw_mi_get_iface_mlme(adapter_to_dvobj(adapter), WIFI_NULL_STATE, WIFI_UNDER_LINKING)

#define rtw_iface_is_operate_at_hwband(adapter, band_idx) true /* this driver has only one hwband */
