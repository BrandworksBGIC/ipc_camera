...
#if (RTW_DEF_MODULE_REGULATORY_CERT & RTW_MODULE_RTL8830AE_HMC_M2) /* 2012 certify */
static const struct country_chplan RTL8830AE_HMC_M2_country_chplan_map[] = {
	COUNTRY_CHPLAN_ENT("AE", 0x35, 1),
	COUNTRY_CHPLAN_ENT("AL", 0x26, 1),
...
#elif (RTW_DEF_MODULE_REGULATORY_CERT == RTW_MODULE_RTL8830AE_HMC_M2)
	*hal_map = RTL8830AE_HMC_M2_country_chplan_map;
	hal_map_sz = sizeof(RTL8830AE_HMC_M2_country_chplan_map) / sizeof(struct country_chplan);
