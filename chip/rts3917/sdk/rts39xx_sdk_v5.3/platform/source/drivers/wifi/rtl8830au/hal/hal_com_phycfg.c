...
static const struct map_t rtl8830a_pg_txpwr_def_info =
	MAP_ENT(0xB8, 1, 0xFF
...
#ifdef CONFIG_RTL8830A
	case RTL8830A:
		map = &rtl8830a_pg_txpwr_def_info;
		break;
#endif
#ifdef CONFIG_RTL8188F
	case RTL8188F:
	...
	, enum channel_width bw, BAND_TYPE band, u8 cch, struct txpwr_idx_comp *tic)
{
	...
	if (IS_HARDWARE_TYPE_8830A(adapter) || IS_HARDWARE_TYPE_8188F(adapter) || IS_HARDWARE_TYPE_8188GTV(adapter)
