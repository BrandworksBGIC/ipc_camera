...
#define __PCI_OPS_H_
	...
	u32	rtl8830ae_init_desc_ring(_adapter *padapter);
	u32	rtl8830ae_free_desc_ring(_adapter *padapter);
	void	rtl8830ae_reset_desc_ring(_adapter *padapter);
	int	rtl8830ae_interrupt(PADAPTER Adapter);
	void	rtl8830ae_xmit_tasklet(void *priv);
	void	rtl8830ae_recv_tasklet(void *priv);
	void	rtl8830ae_prepare_bcn_tasklet(void *priv);
	void	rtl8830ae_set_intf_ops(struct _io_ops	*pops);
	void	rtw8830ae_unmap_beacon_icf(_adapter *padapter);
#endif
