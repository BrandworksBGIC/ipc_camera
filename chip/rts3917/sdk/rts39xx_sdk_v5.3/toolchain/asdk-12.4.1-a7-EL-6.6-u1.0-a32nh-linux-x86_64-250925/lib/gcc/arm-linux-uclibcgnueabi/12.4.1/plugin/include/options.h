...
enum opt_code
{
  ...
  OPT_Tbss_ = 425,                           /* -Tbss= */
  OPT_Tdata = 426,                           /* -Tdata */
  OPT_Tdata_ = 427,                          /* -Tdata= */
  OPT_Ttext = 428,                           /* -Ttext */
  OPT_Ttext_ = 429,                          /* -Ttext= */
  OPT_U = 430,                               /* -U */
  /* OPT_W = 431, */                         /* -W */
  OPT_WNSObject_attribute = 432,             /* -WNSObject-attribute */
  OPT_Wa_ = 433,                             /* -Wa, */
  OPT_Wabi = 434,                            /* -Wabi */
  OPT_Wabi_tag = 435,                        /* -Wabi-tag */
  OPT_Wabi_ = 436,                           /* -Wabi= */
  OPT_Wabsolute_value = 437,                 /* -Wabsolute-value */
  OPT_Waddress = 438,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 439,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 440,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 441,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 442,                       /* -Waliasing */
  OPT_Walign_commons = 443,                  /* -Walign-commons */
  /* OPT_Waligned_new = 444, */              /* -Waligned-new */
  OPT_Waligned_new_ = 445,                   /* -Waligned-new= */
  OPT_Wall = 446,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 447,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 448,                     /* -Walloc-zero */
  OPT_Walloca = 449,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 450,            /* -Walloca-larger-than= */
  OPT_Wampersand = 451,                      /* -Wampersand */
  OPT_Wanalyzer_double_fclose = 452,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 453,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 454,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_file_leak = 455,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 456,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_malloc_leak = 457,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 458,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 459,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 460,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_possible_null_argument = 461,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 462,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_shift_count_negative = 463,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 464,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 465,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_allocation_size = 466,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 467,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_divisor = 468,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 469,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 470,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 471,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 472,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 473,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 474,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 475,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_write_to_const = 476,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 477,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 478,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 479,               /* -Warith-conversion */
  OPT_Warray_bounds = 480,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 481,                  /* -Warray-bounds= */
  OPT_Warray_compare = 482,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 483, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 484,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 485,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 486,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 487, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 488,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 489,              /* -Wattribute-warning */
  OPT_Wattributes = 490,                     /* -Wattributes */
  OPT_Wattributes_ = 491,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 492,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 493, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 494,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 495,                   /* -Wbool-compare */
  OPT_Wbool_operation = 496,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 497,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 498,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 499,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 500, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 501,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 502,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 503,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 504,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 505,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 506,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 507, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 508,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 509,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 510,               /* -Wc++23-extensions */
  /* OPT_Wc__2a_compat = 511, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 512,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 513,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 514,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 515,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 516,                 /* -Wcannot-profile */
  OPT_Wcast_align = 517,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 518,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 519,             /* -Wcast-function-type */
  OPT_Wcast_qual = 520,                      /* -Wcast-qual */
  OPT_Wcast_result = 521,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 522, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 523,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 524,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 525,           /* -Wcharacter-truncation */
  OPT_Wchkp = 526,                           /* -Wchkp */
  OPT_Wclass_conversion = 527,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 528,                /* -Wclass-memaccess */
  OPT_Wclobbered = 529,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 530,                /* -Wcomma-subscript */
  OPT_Wcomment = 531,                        /* -Wcomment */
  /* OPT_Wcomments = 532, */                 /* -Wcomments */
  OPT_Wcompare_reals = 533,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 534,        /* -Wconditionally-supported */
  OPT_Wconversion = 535,                     /* -Wconversion */
  OPT_Wconversion_extra = 536,               /* -Wconversion-extra */
  OPT_Wconversion_null = 537,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 538,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 539,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 540,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 541,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 542,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 543,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 544, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 545,              /* -Wdangling-pointer= */
  OPT_Wdate_time = 546,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 547,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 548,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 549,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 550,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 551,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 552,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 553,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 554,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 555,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 556,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 557,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 558,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 559,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 560,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 561,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 562,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 563,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 564,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 565,                /* -Wduplicated-cond */
  OPT_Weffc__ = 566,                         /* -Weffc++ */
  OPT_Wempty_body = 567,                     /* -Wempty-body */
  OPT_Wendif_labels = 568,                   /* -Wendif-labels */
  OPT_Wenum_compare = 569,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 570,                /* -Wenum-conversion */
  OPT_Werror = 571,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 572, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 573,                         /* -Werror= */
  OPT_Wexceptions = 574,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 575,           /* -Wexpansion-to-defined */
  OPT_Wextra = 576,                          /* -Wextra */
  OPT_Wextra_semi = 577,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 578,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 579,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 580,                    /* -Wfloat-equal */
  /* OPT_Wformat = 581, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 582,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 583,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 584,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 585,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 586, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 587,               /* -Wformat-overflow= */
  OPT_Wformat_security = 588,                /* -Wformat-security */
  OPT_Wformat_signedness = 589,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 590, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 591,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 592,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 593,             /* -Wformat-zero-length */
  OPT_Wformat_ = 594,                        /* -Wformat= */
  OPT_Wframe_address = 595,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 596,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 597,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 598,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 599,           /* -Wfunction-elimination */
  /* OPT_Whsa = 600, */                      /* -Whsa */
  OPT_Wif_not_aligned = 601,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 602,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 603,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 604,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 605, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 606,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 607,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 608,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 609,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 610,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 611, */                   /* -Wimport */
  OPT_Winaccessible_base = 612,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 613,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 614,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 615,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 616,             /* -Winit-list-lifetime */
  OPT_Winit_self = 617,                      /* -Winit-self */
  OPT_Winline = 618,                         /* -Winline */
  OPT_Wint_conversion = 619,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 620,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 621,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 622,               /* -Winteger-division */
  OPT_Winterference_size = 623,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 624,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 625,                 /* -Wintrinsics-std */
  OPT_Winvalid_imported_macros = 626,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 627,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 628,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 629,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 630,               /* -Wjump-misses-init */
  OPT_Wl_ = 631,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 632, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 633,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 634,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 635,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 636,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 637,                     /* -Wlogical-op */
  OPT_Wlong_long = 638,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 639,              /* -Wlto-type-mismatch */
  OPT_Wmain = 640,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 641,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 642,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 643,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 644,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 645,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 646,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_tags = 647,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 648,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 649,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 650,           /* -Wmissing-declarations */
  OPT_Wmissing_delay_slot = 651,             /* -Wmissing-delay-slot */
  ...
  OPT_Wpossible_load_use = 711,              /* -Wpossible-load-use */
  OPT_Wpragmas = 712,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 713,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 714,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 715,                       /* -Wprotocol */
  OPT_Wpsabi = 716,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 717,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 718,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 719,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 720,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 721,                /* -Wredundant-decls */
  OPT_Wredundant_move = 722,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 723,                 /* -Wredundant-tags */
  OPT_Wregister = 724,                       /* -Wregister */
  OPT_Wreorder = 725,                        /* -Wreorder */
  OPT_Wrestrict = 726,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 727,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 728,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 729,           /* -Wscalar-storage-order */
  OPT_Wselector = 730,                       /* -Wselector */
  OPT_Wsequence_point = 731,                 /* -Wsequence-point */
  OPT_Wshadow = 732,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 733, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 734,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 735, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 736,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 737, */            /* -Wshadow=global */
  OPT_Wshadow_local = 738,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 739,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 740,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 741,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 742, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 743,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 744,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 745,                /* -Wsign-conversion */
  OPT_Wsign_promo = 746,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 747,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 748,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 749,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 750,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 751,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 752,                    /* -Wspeculative */
  OPT_Wstack_protector = 753,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 754,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 755,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 756,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 757,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 758,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 759,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 760,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 761,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 762,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 763, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 764,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 765,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 766,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 767,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 768,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 769,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 770,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 771,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 772,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 773,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 774,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 775,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 776,               /* -Wsuggest-override */
  OPT_Wsurprising = 777,                     /* -Wsurprising */
  OPT_Wswitch = 778,                         /* -Wswitch */
  OPT_Wswitch_bool = 779,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 780,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 781,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 782,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 783,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 784,                      /* -Wsync-nand */
  OPT_Wsynth = 785,                          /* -Wsynth */
  OPT_Wsystem_headers = 786,                 /* -Wsystem-headers */
  OPT_Wtabs = 787,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 788,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 789,           /* -Wtautological-compare */
  OPT_Wtemplates = 790,                      /* -Wtemplates */
  OPT_Wterminate = 791,                      /* -Wterminate */
  OPT_Wtraditional = 792,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 793,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 794,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 795,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 796,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 797,                           /* -Wtsan */
  OPT_Wtype_limits = 798,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 799,            /* -Wundeclared-selector */
  OPT_Wundef = 800,                          /* -Wundef */
  OPT_Wundefined_do_loop = 801,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 802,                      /* -Wunderflow */
  OPT_Wuninitialized = 803,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 804,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 805, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 806, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 807,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 808,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 809,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 810,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 811, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 812,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 813,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 814,                /* -Wunused-function */
  OPT_Wunused_label = 815,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 816,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 817,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 818,               /* -Wunused-parameter */
  OPT_Wunused_result = 819,                  /* -Wunused-result */
  OPT_Wunused_value = 820,                   /* -Wunused-value */
  OPT_Wunused_variable = 821,                /* -Wunused-variable */
  OPT_Wuse_after_free = 822,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 823,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 824,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 825,                   /* -Wuseless-cast */
  OPT_Wvarargs = 826,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 827,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 828,   /* -Wvector-operation-performance */
  OPT_Wvexing_parse = 829,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 830,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 831,            /* -Wvirtual-move-assign */
  OPT_Wvla = 832,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 833,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 834,                  /* -Wvla-parameter */
  OPT_Wvolatile = 835,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 836,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 837,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 838,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 839,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 840,                       /* -Wzerotrip */
  OPT_X = 841,                               /* -X */
  OPT_Xassembler = 842,                      /* -Xassembler */
  OPT_Xf = 843,                              /* -Xf */
  OPT_Xlinker = 844,                         /* -Xlinker */
  OPT_Xpreprocessor = 845,                   /* -Xpreprocessor */
  OPT_Z = 846,                               /* -Z */
  OPT_ansi = 847,                            /* -ansi */
  OPT_aux_info = 848,                        /* -aux-info */
  /* OPT_aux_info_ = 849, */                 /* -aux-info= */
  OPT_c = 850,                               /* -c */
  OPT_callgraph = 851,                       /* -callgraph */
  OPT_coverage = 852,                        /* -coverage */
  OPT_cpp = 853,                             /* -cpp */
  OPT_cpp_ = 854,                            /* -cpp= */
  OPT_d = 855,                               /* -d */
  OPT_debuglib_ = 856,                       /* -debuglib= */
  OPT_defaultlib_ = 857,                     /* -defaultlib= */
  OPT_defined_only = 858,                    /* -defined-only */
  OPT_demangle = 859,                        /* -demangle */
  OPT_dstartfiles = 860,                     /* -dstartfiles */
  OPT_dump_body_ = 861,                      /* -dump-body= */
  OPT_dump_level_ = 862,                     /* -dump-level= */
  OPT_dumpbase = 863,                        /* -dumpbase */
  OPT_dumpbase_ext = 864,                    /* -dumpbase-ext */
  OPT_dumpdir = 865,                         /* -dumpdir */
  OPT_dumpfullversion = 866,                 /* -dumpfullversion */
  OPT_dumpmachine = 867,                     /* -dumpmachine */
  OPT_dumpspecs = 868,                       /* -dumpspecs */
  OPT_dumpversion = 869,                     /* -dumpversion */
  OPT_e = 870,                               /* -e */
  OPT_export_dynamic = 871,                  /* -export-dynamic */
  OPT_fPIC = 872,                            /* -fPIC */
  OPT_fPIE = 873,                            /* -fPIE */
  OPT_fRTS_ = 874,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 875,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 876,                   /* -fabi-version= */
  OPT_faccess_control = 877,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 878,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 879,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 880,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 881,                  /* -falign-commons */
  OPT_falign_functions = 882,                /* -falign-functions */
  OPT_falign_functions_ = 883,               /* -falign-functions= */
  OPT_falign_jumps = 884,                    /* -falign-jumps */
  OPT_falign_jumps_ = 885,                   /* -falign-jumps= */
  OPT_falign_labels = 886,                   /* -falign-labels */
  OPT_falign_labels_ = 887,                  /* -falign-labels= */
  OPT_falign_loops = 888,                    /* -falign-loops */
  OPT_falign_loops_ = 889,                   /* -falign-loops= */
  /* OPT_faligned_new = 890, */              /* -faligned-new */
  OPT_faligned_new_ = 891,                   /* -faligned-new= */
  OPT_fall_instantiations = 892,             /* -fall-instantiations */
  OPT_fall_intrinsics = 893,                 /* -fall-intrinsics */
  OPT_fall_virtual = 894,                    /* -fall-virtual */
  OPT_fallocation_dce = 895,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 896,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 897,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 898,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 899,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 900,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 901,         /* -falt-external-templates */
  OPT_fanalyzer = 902,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 903,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 904,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 905,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 906,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 907,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 908,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 909,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 910,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 911,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 912, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 913,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 914, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 915, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 916, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 917, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 918,            /* -fasan-shadow-offset= */
  OPT_fasm = 919,                            /* -fasm */
  OPT_fassert = 920,                         /* -fassert */
  OPT_fassociative_math = 921,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 922,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 923,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 924,                   /* -fauto-profile */
  OPT_fauto_profile_ = 925,                  /* -fauto-profile= */
  OPT_fautomatic = 926,                      /* -fautomatic */
  OPT_fbackslash = 927,                      /* -fbackslash */
  OPT_fbacktrace = 928,                      /* -fbacktrace */
  OPT_fbit_tests = 929,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 930,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 931,                   /* -fbounds-check */
  OPT_fbounds_check_ = 932,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 933,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 934,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 935, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 936, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 937, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 938,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 939,           /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 940,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 941,                        /* -fbuiltin */
  OPT_fbuiltin_ = 942,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 943,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 944,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 945,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 946,                    /* -fcall-saved- */
  OPT_fcall_used_ = 947,                     /* -fcall-used- */
  OPT_fcaller_saves = 948,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 949,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 950,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 951,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 952, */            /* -fcf-protection */
  OPT_fcf_protection_ = 953,                 /* -fcf-protection= */
  OPT_fchar8_t = 954,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 955,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 956, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 957,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 958,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 959,                         /* -fcheck= */
  /* OPT_fcheck_assert = 960, */             /* -fcheck=assert */
  /* OPT_fcheck_bounds = 961, */             /* -fcheck=bounds */
  /* OPT_fcheck_in = 962, */                 /* -fcheck=in */
  /* OPT_fcheck_invariant = 963, */          /* -fcheck=invariant */
  /* OPT_fcheck_out = 964, */                /* -fcheck=out */
  /* OPT_fcheck_switch = 965, */             /* -fcheck=switch */
  OPT_fcheckaction_ = 966,                   /* -fcheckaction= */
  OPT_fchecking = 967,                       /* -fchecking */
  OPT_fchecking_ = 968,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 969,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 970,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 971,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 972,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 973,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 974,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 975,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 976,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 977, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 978,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 979,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 980,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 981, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 982,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 983,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 984,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 985,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 986,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 987, */                 /* -fcilkplus */
  OPT_fcoarray_ = 988,                       /* -fcoarray= */
  OPT_fcode_hoisting = 989,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 990,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 991,                         /* -fcommon */
  OPT_fcompare_debug = 992,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 993,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 994,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 995,                   /* -fcompare-elim */
  OPT_fconcepts = 996,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 997,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 998,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 999,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 1000, */          /* -fconserve-space */
  OPT_fconserve_stack = 1001,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1002,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1003,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1004,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1005,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1006,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1007,          /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 1008,                      /* -fconvert= */
  OPT_fcoroutines = 1009,                    /* -fcoroutines */
  OPT_fcprop_registers = 1010,               /* -fcprop-registers */
  OPT_fcray_pointer = 1011,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1012,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1013,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1014, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1015,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1016,              /* -fcx-limited-range */
  OPT_fd_lines_as_code = 1017,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1018,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1019,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1020,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1021,                      /* -fdbg-cnt= */
  OPT_fdce = 1022,                           /* -fdce */
  OPT_fdebug = 1023,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1024,                /* -fdebug-aux-vars */
  OPT_fdebug_cpp = 1025,                     /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 1026,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1027,           /* -fdebug-types-section */
  OPT_fdebug_ = 1028,                        /* -fdebug= */
  OPT_fdec = 1029,                           /* -fdec */
  OPT_fdec_blank_format_item = 1030,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1031,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1032,           /* -fdec-format-defaults */
  OPT_fdec_include = 1033,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1034,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1035,                      /* -fdec-math */
  OPT_fdec_static = 1036,                    /* -fdec-static */
  OPT_fdec_structure = 1037,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1038,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1039, */        /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 1040,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1041, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1042,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1043,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1044,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1045,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1046,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1047,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1048,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1049,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1050,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1051,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1052,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1053, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1054,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1055,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1056,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1057,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1058,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1059,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1060,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1061,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1062,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1063,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1064,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1065,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1066,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1067, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1068,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1069,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1070,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 1071,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1072,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1073,               /* -fdirectives-only */
  OPT_fdisable_ = 1074,                      /* -fdisable- */
  OPT_fdoc = 1075,                           /* -fdoc */
  OPT_fdoc_dir_ = 1076,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1077,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1078,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1079,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1080,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1081,                      /* -fdruntime */
  OPT_fdse = 1082,                           /* -fdse */
  OPT_fdump_ = 1083,                         /* -fdump- */
  OPT_fdump_ada_spec = 1084,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1085,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1086,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1087,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1088,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1089,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1090,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1091,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1092,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1093,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1094,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1095,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1096,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1097,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1098,       /* -fdump-analyzer-untracked */
  ...
  OPT_ffold_simple_inlines = 1152,           /* -ffold-simple-inlines */
  ...
  OPT_frevert_dip1000 = 1482,                /* -frevert=dip1000 */
  ...
  OPT_ftword = 1655,                         /* -ftword */
  OPT_ftword_stack = 1656,                   /* -ftword-stack */
  ...
  OPT_fuse_tls = 1678,                       /* -fuse-tls */
  OPT_fuse_uls = 1679,                       /* -fuse-uls */
  OPT_fvar_tracking = 1680,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1681,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1682,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1683,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1684,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1685, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1686,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1687,                   /* -fverbose-asm */
  /* OPT_fversion = 1688, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1689,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1690,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1691,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1692,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1693,                   /* -fvisibility= */
  OPT_fvpt = 1694,                           /* -fvpt */
  OPT_fvtable_gc = 1695,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1696,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1697,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1698,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1699,                     /* -fvtv-debug */
  OPT_fweak = 1700,                          /* -fweak */
  OPT_fweak_templates = 1701,                /* -fweak-templates */
  OPT_fweb = 1702,                           /* -fweb */
  /* OPT_fwhole_file = 1703, */              /* -fwhole-file */
  OPT_fwhole_program = 1704,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1705,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1706,             /* -fworking-directory */
  OPT_fwpa = 1707,                           /* -fwpa */
  OPT_fwpa_ = 1708,                          /* -fwpa= */
  OPT_fwrapv = 1709,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1710,                 /* -fwrapv-pointer */
  OPT_fxref = 1711,                          /* -fxref */
  /* OPT_fzee = 1712, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1713,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1714,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1715,                     /* -fzero-link */
  OPT_g = 1716,                              /* -g */
  OPT_gant = 1717,                           /* -gant */
  OPT_gas_loc_support = 1718,                /* -gas-loc-support */
  OPT_gas_locview_support = 1719,            /* -gas-locview-support */
  OPT_gbtf = 1720,                           /* -gbtf */
  OPT_gcoff = 1721,                          /* -gcoff */
  OPT_gcoff1 = 1722,                         /* -gcoff1 */
  OPT_gcoff2 = 1723,                         /* -gcoff2 */
  OPT_gcoff3 = 1724,                         /* -gcoff3 */
  OPT_gcolumn_info = 1725,                   /* -gcolumn-info */
  OPT_gctf = 1726,                           /* -gctf */
  OPT_gdescribe_dies = 1727,                 /* -gdescribe-dies */
  OPT_gdwarf = 1728,                         /* -gdwarf */
  OPT_gdwarf_ = 1729,                        /* -gdwarf- */
  OPT_gdwarf32 = 1730,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1731,                       /* -gdwarf64 */
  OPT_gen_decls = 1732,                      /* -gen-decls */
  OPT_ggdb = 1733,                           /* -ggdb */
  OPT_ggnu_pubnames = 1734,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1735,                   /* -gimple-stats */
  OPT_ginline_points = 1736,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1737, /* -ginternal-reset-location-views */
  OPT_gnat = 1738,                           /* -gnat */
  OPT_gnatO = 1739,                          /* -gnatO */
  OPT_gno_ = 1740,                           /* -gno- */
  OPT_gno_pubnames = 1741,                   /* -gno-pubnames */
  OPT_gpubnames = 1742,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1743,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1744,                   /* -gsplit-dwarf */
  OPT_gstabs = 1745,                         /* -gstabs */
  OPT_gstabs_ = 1746,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1747,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1748,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1749,                        /* -gtoggle */
  OPT_gvariable_location_views = 1750,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1751,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1752,                           /* -gvms */
  OPT_gxcoff = 1753,                         /* -gxcoff */
  OPT_gxcoff_ = 1754,                        /* -gxcoff+ */
  OPT_gz = 1755,                             /* -gz */
  OPT_gz_ = 1756,                            /* -gz= */
  OPT_h = 1757,                              /* -h */
  OPT_help = 1758,                           /* -help */
  OPT_idirafter = 1759,                      /* -idirafter */
  OPT_imacros = 1760,                        /* -imacros */
  OPT_imultiarch = 1761,                     /* -imultiarch */
  OPT_imultilib = 1762,                      /* -imultilib */
  OPT_include = 1763,                        /* -include */
  OPT_iplugindir_ = 1764,                    /* -iplugindir= */
  OPT_iprefix = 1765,                        /* -iprefix */
  OPT_iquote = 1766,                         /* -iquote */
  OPT_isysroot = 1767,                       /* -isysroot */
  OPT_isystem = 1768,                        /* -isystem */
  OPT_iwithprefix = 1769,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1770,              /* -iwithprefixbefore */
  OPT_k8 = 1771,                             /* -k8 */
  OPT_l = 1772,                              /* -l */
  OPT_lang_asm = 1773,                       /* -lang-asm */
  OPT_list = 1774,                           /* -list */
  OPT_mabi_ = 1775,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1776,             /* -mabort-on-noreturn */
  OPT_mandroid = 1777,                       /* -mandroid */
  OPT_mapcs = 1778,                          /* -mapcs */
  OPT_mapcs_frame = 1779,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1780,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1781,              /* -mapcs-stack-check */
  OPT_march_ = 1782,                         /* -march= */
  OPT_marm = 1783,                           /* -marm */
  OPT_masm_syntax_unified = 1784,            /* -masm-syntax-unified */
  OPT_mbe32 = 1785,                          /* -mbe32 */
  OPT_mbe8 = 1786,                           /* -mbe8 */
  OPT_mbig_endian = 1787,                    /* -mbig-endian */
  OPT_mbionic = 1788,                        /* -mbionic */
  OPT_mbranch_cost_ = 1789,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1790,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1791,     /* -mcaller-super-interworking */
  OPT_mcmse = 1792,                          /* -mcmse */
  OPT_mcpu_ = 1793,                          /* -mcpu= */
  OPT_mfdpic = 1794,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1795,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1796,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1797, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1798,            /* -mfix-cortex-m3-ldrd */
  OPT_mfix_vldstr = 1799,                    /* -mfix-vldstr */
  OPT_mflip_thumb = 1800,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1801,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1802,                  /* -mfp16-format= */
  OPT_mfpu_ = 1803,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1804,             /* -mgeneral-regs-only */
  OPT_mglibc = 1805,                         /* -mglibc */
  /* OPT_mhard_float = 1806, */              /* -mhard-float */
  OPT_mlibarch_ = 1807,                      /* -mlibarch= */
  OPT_mlittle_endian = 1808,                 /* -mlittle-endian */
  OPT_mlong_calls = 1809,                    /* -mlong-calls */
  OPT_mmusl = 1810,                          /* -mmusl */
  OPT_mneon_for_64bits = 1811,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1812,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1813,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1814,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1815,               /* -mprint-tune-info */
  OPT_mpure_code = 1816,                     /* -mpure-code */
  OPT_mrestrict_it = 1817,                   /* -mrestrict-it */
  OPT_msched_prolog = 1818,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1819,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1820,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1821, */              /* -msoft-float */
  ...
  OPT_mstructure_size_boundary_ = 1824,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1825,                         /* -mthumb */
  OPT_mthumb_interwork = 1826,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1827,                  /* -mtls-dialect= */
  OPT_mtp_ = 1828,                           /* -mtp= */
  OPT_mtpcs_frame = 1829,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1830,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1831,                         /* -mtune= */
  OPT_muclibc = 1832,                        /* -muclibc */
  OPT_munaligned_access = 1833,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1834,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1835,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1836,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1837,              /* -mword-relocations */
  OPT_n = 1838,                              /* -n */
  ...
  OPT_o = 1851,                              /* -o */
  OPT_objects = 1852,                        /* -objects */
  OPT_p = 1853,                              /* -p */
  OPT_pass_exit_codes = 1854,                /* -pass-exit-codes */
  /* OPT_pedantic = 1855, */                 /* -pedantic */
  OPT_pedantic_errors = 1856,                /* -pedantic-errors */
  OPT_pg = 1857,                             /* -pg */
  OPT_pie = 1858,                            /* -pie */
  OPT_pipe = 1859,                           /* -pipe */
  OPT_posix = 1860,                          /* -posix */
  ...
  OPT_profile = 1873,                        /* -profile */
  OPT_pthread = 1874,                        /* -pthread */
  OPT_quiet = 1875,                          /* -quiet */
  OPT_r = 1876,                              /* -r */
  OPT_rdynamic = 1877,                       /* -rdynamic */
  OPT_remap = 1878,                          /* -remap */
  OPT_reverse_sort = 1879,                   /* -reverse-sort */
  OPT_s = 1880,                              /* -s */
  OPT_save_temps = 1881,                     /* -save-temps */
  OPT_save_temps_ = 1882,                    /* -save-temps= */
  OPT_shared = 1883,                         /* -shared */
  OPT_shared_libgcc = 1884,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1885,               /* -shared-libphobos */
  OPT_size_sort = 1886,                      /* -size-sort */
  /* OPT_specs = 1887, */                    /* -specs */
  OPT_specs_ = 1888,                         /* -specs= */
  OPT_static = 1889,                         /* -static */
  OPT_static_libasan = 1890,                 /* -static-libasan */
  OPT_static_libgcc = 1891,                  /* -static-libgcc */
  OPT_static_libgfortran = 1892,             /* -static-libgfortran */
  OPT_static_libgo = 1893,                   /* -static-libgo */
  OPT_static_libhwasan = 1894,               /* -static-libhwasan */
  OPT_static_liblsan = 1895,                 /* -static-liblsan */
  OPT_static_libmpx = 1896,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1897,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1898,               /* -static-libphobos */
  OPT_static_libstdc__ = 1899,               /* -static-libstdc++ */
  OPT_static_libtsan = 1900,                 /* -static-libtsan */
  OPT_static_libubsan = 1901,                /* -static-libubsan */
  OPT_static_pie = 1902,                     /* -static-pie */
  /* OPT_std_c__03 = 1903, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1904, */                /* -std=c++0x */
  OPT_std_c__11 = 1905,                      /* -std=c++11 */
  OPT_std_c__14 = 1906,                      /* -std=c++14 */
  OPT_std_c__17 = 1907,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1908, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1909, */                /* -std=c++1z */
  OPT_std_c__20 = 1910,                      /* -std=c++20 */
  OPT_std_c__23 = 1911,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1912, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1913, */                /* -std=c++2b */
  OPT_std_c__98 = 1914,                      /* -std=c++98 */
  OPT_std_c11 = 1915,                        /* -std=c11 */
  OPT_std_c17 = 1916,                        /* -std=c17 */
  /* OPT_std_c18 = 1917, */                  /* -std=c18 */
  /* OPT_std_c1x = 1918, */                  /* -std=c1x */
  OPT_std_c2x = 1919,                        /* -std=c2x */
  /* OPT_std_c89 = 1920, */                  /* -std=c89 */
  OPT_std_c90 = 1921,                        /* -std=c90 */
  OPT_std_c99 = 1922,                        /* -std=c99 */
  /* OPT_std_c9x = 1923, */                  /* -std=c9x */
  OPT_std_f2003 = 1924,                      /* -std=f2003 */
  OPT_std_f2008 = 1925,                      /* -std=f2008 */
  OPT_std_f2008ts = 1926,                    /* -std=f2008ts */
  OPT_std_f2018 = 1927,                      /* -std=f2018 */
  OPT_std_f95 = 1928,                        /* -std=f95 */
  OPT_std_gnu = 1929,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1930, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1931, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1932,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1933,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1934,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1935, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1936, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1937,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1938,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1939, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1940, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1941,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1942,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1943,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1944, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1945, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1946,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1947, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1948,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1949,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1950, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1951, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1952,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1953, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1954, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1955, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1956, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1957, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1958,                     /* -std=legacy */
  OPT_stdlib_ = 1959,                        /* -stdlib= */
  OPT_symbol_ = 1960,                        /* -symbol= */
  OPT_symbolic = 1961,                       /* -symbolic */
  OPT_t = 1962,                              /* -t */
  OPT_time = 1963,                           /* -time */
  OPT_time_ = 1964,                          /* -time= */
  OPT_tno_android_cc = 1965,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1966,                 /* -tno-android-ld */
