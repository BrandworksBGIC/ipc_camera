...
#define HAVE_mve_vshlq_sv8qi (TARGET_NEON && ARM_HAVE_V8QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_uv8qi (TARGET_NEON && ARM_HAVE_V8QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_sv16qi (TARGET_NEON && ARM_HAVE_V16QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_uv16qi (TARGET_NEON && ARM_HAVE_V16QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_sv4hi (TARGET_NEON && ARM_HAVE_V4HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_uv4hi (TARGET_NEON && ARM_HAVE_V4HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_sv8hi (TARGET_NEON && ARM_HAVE_V8HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_uv8hi (TARGET_NEON && ARM_HAVE_V8HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_sv2si (TARGET_NEON && ARM_HAVE_V2SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_uv2si (TARGET_NEON && ARM_HAVE_V2SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_sv4si (TARGET_NEON && ARM_HAVE_V4SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_mve_vshlq_uv4si (TARGET_NEON && ARM_HAVE_V4SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_sv8qi (ARM_HAVE_V8QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_uv8qi (ARM_HAVE_V8QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_sv16qi (ARM_HAVE_V16QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_uv16qi (ARM_HAVE_V16QI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_sv4hi (ARM_HAVE_V4HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_uv4hi (ARM_HAVE_V4HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_sv8hi (ARM_HAVE_V8HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_uv8hi (ARM_HAVE_V8HI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_sv2si (ARM_HAVE_V2SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_uv2si (ARM_HAVE_V2SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_sv4si (ARM_HAVE_V4SI_ARITH && !TARGET_REALLY_IWMMXT)
#define HAVE_real_mve_vshlq_uv4si (ARM_HAVE_V4SI_ARITH && !TARGET_REALLY_IWMMXT)
...
extern rtx        gen_real_mve_vshlq_sv8qi                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_uv8qi                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_sv16qi                          (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_uv16qi                          (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_sv4hi                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_uv4hi                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_sv8hi                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_uv8hi                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_sv2si                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_uv2si                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_sv4si                           (rtx, rtx, rtx);
extern rtx        gen_real_mve_vshlq_uv4si                           (rtx, rtx, rtx);
