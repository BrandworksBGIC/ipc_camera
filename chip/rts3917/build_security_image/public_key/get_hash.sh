...
cp rts3917_sec_boot_public.pem verity_key0.pem
cp rts3917_sec_boot_public.pem verity_key1.pem
cp rts3917_sec_boot_public.pem verity_key2.pem
...
cp verity_key2.der ../../fw/rootfs/rootfs_cprt/etc/keys/verity_key2.der
cp verity_key2.der ../../rts39xx_sdk_v5.3/out/rts3917n_base/target-mini/etc/keys/
cp verity_key2.der ../../rts39xx_sdk_v5.3/out/rts3918n_base/target-mini/etc/keys/


cp ../crypto_key/crypto_* ../../rts39xx_sdk_v5.3/out/rts3917n_base/rtskey/
cp ../crypto_key/crypto_* ../../rts39xx_sdk_v5.3/out/rts3918n_base/rtskey/

cp ../crypto_key/crypto_* ../../rts39xx_sdk_v5.3/out/rts3917n_base/target-mini/etc/keys/
cp ../crypto_key/crypto_* ../../rts39xx_sdk_v5.3/out/rts3918n_base/target-mini/etc/keys/



cp verity_key1.pem ../../rts39xx_sdk_v5.3/out/rts3917n_base/rtskey/
...
create_mkimage_wrapper "../../rts39xx_sdk_v5.3/out/rts3917n_base"
create_mkimage_wrapper "../../rts39xx_sdk_v5.3/out/rts3918n_base"

# ../../rts39xx_sdk_v5.3/out/rts3917n_base/host/bin/mkimage
# ../../rts39xx_sdk_v5.3/out/rts3918n_base/host/bin/mkimage 
